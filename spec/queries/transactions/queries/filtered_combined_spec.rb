  ...
  describe '#call' do
    ...
    context 'with mocked queries' do
      ...
      it 'calls where with the correct space conditions' do
        ...
        expect(mock_relation).to receive(:where).with(space: space1).and_return(mock_relation)
      ...
      it 'paginates with the correct parameters' do
        ...
        # Verify pagination
        expect(mock_relation).to receive(:page).with(1).and_return(mock_relation)
        expect(mock_relation).to receive(:per).with(25).and_return(mock_relation)
      ...
      it 'paginates with custom per_page' do
        ...
        expect(mock_relation).to receive(:page).with(1).and_return(mock_relation)
        expect(mock_relation).to receive(:per).with(10).and_return(mock_relation)
      ...
      it 'calls where with the correct amount conditions for min_amount' do
        ...
        expect(mock_relation).to receive(:where).with(amount_cents: 1500...Float::INFINITY)
          .and_return(mock_relation)
      ...
      it 'calls where with the correct amount conditions for max_amount' do
        ...
        expect(mock_relation).to receive(:where).with(amount_cents: 0...1000)
          .and_return(mock_relation)
      ...
      it 'calls where with the correct amount conditions for both min and max' do
        ...
        expect(mock_relation).to receive(:where).with(amount_cents: 500...1000)
          .and_return(mock_relation)
