...
RSpec.describe Transactions::Category, type: :model do
  ...
  describe '.create_default_categories' do
    ...
    let(:default_income_count) { Transactions::Category::DEFAULT_INCOME_CATEGORIES.count }
    ...
    it 'creates categories with the correct names and types' do
      ...
      expect(income_names).to match_array(Transactions::Category::DEFAULT_INCOME_CATEGORIES)
