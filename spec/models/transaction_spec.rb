  ...
  describe 'enums' do
    ...
    describe 'transaction_type enum' do
      it 'defines the expected values' do
        expect(Transaction.transaction_types).to eq({"income"=>"income", "expense"=>"expense"})
      end
      
      it 'provides predicate methods' do
        transaction = Transaction.new(transaction_type: 'income', expense_category: 'food', income_category: 'salary')
    ...
    describe 'expense_category enum' do
      it 'defines the expected values' do
        ...
        expect(Transaction.expense_categories).to eq(expected_categories)
      end
      
      it 'provides predicate methods' do
        transaction = Transaction.new(expense_category: 'food')
    ...
    describe 'income_category enum' do
      it 'defines the expected values' do
        ...
        expect(Transaction.income_categories).to eq(expected_categories)
      end
      
      it 'provides predicate methods' do
        transaction = Transaction.new(income_category: 'salary')
