  ...
  describe '#call' do
    context 'with valid parameters' do
      ...
      it 'returns the correct health scores hash' do
        ...
        expect(result[:budget_usage]).to eq(Utils::Number.format_percentage(BigDecimal('120.0')))
      end
    end
    ...
    describe 'Calculation Logic Edge Cases' do
      ...
      context 'when total_budget is zero (from budgets with zero amounts)' do
        ...
        it 'returns budget_usage as integer 0' do
          expect(call_operation.value![:budget_usage]).to eq(0)
        end
      end
    end
  end
