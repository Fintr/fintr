  ...
  return (
    <div className="max-w-md mx-auto bg-gray-100 p-1 rounded-lg flex mb-6">
      <Button
        ...
        className={`flex-1 ${activeTab === "login" ? "bg-primary text-white shadow-sm" : "bg-transparent hover:bg-gray-200"}`}
      ...
      <Button
        ...
        className={`flex-1 ${activeTab === "signup" ? "bg-primary text-white shadow-sm" : "bg-transparent hover:bg-gray-200"}`}
