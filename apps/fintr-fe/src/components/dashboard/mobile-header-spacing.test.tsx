...
describe("Mobile Header Spacer - Top Safe Area", () => {
  describe("calculateHeaderSpacerHeight function", () => {
    it("should calculate Android native spacer with minimum 40px + safe area", () => {
  ...
  describe("Dashboard Layout - Header Spacer", () => {
    it("should include spacer height that accounts for safe area", () => {
      ...
      // Android and Browser should include 40px base
      expect(androidHeight).toContain("40px");
      expect(browserHeight).toContain("40px");

      // Android native is fixed to 40px to avoid post-rotation drift
