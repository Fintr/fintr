 ...
 * Uses Auth0's /authorize endpoint to initiate OAuth flow with Apple connection
 */
...
/**
 * Initiates Apple Sign-In via Auth0
 * Redirects user to Auth0's Universal Login with Apple connection
 */
export const initiateAppleSignIn = (options?: AppleSignInOptions) => {
