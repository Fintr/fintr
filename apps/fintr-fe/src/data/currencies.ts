/**
 * ISO 4217 currency codes and names (current currencies).
 * Used for workspace currency picker; search is done client-side on this list.
 */
...
/**
 * Map currency code to ISO 3166-1 alpha-2 country code for flag display.
 * Default: first two letters of currency. Override for multi-country or different codes.
 */
