...
export default function ProblemSection() {
  return (
    <section id="problem" className="landing-section-y">
      <div className="max-w-[1200px] mx-auto px-6 sm:px-10 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-[#0A2540] rounded-[16px] p-8 transition-all hover:border-[rgba(255,255,255,0.1)]">
            <div className="font-landing-title text-[48px] font-bold text-[#14B8A6] leading-none mb-4">
              01
            </div>
          ...
          <div className="bg-[#0A2540] rounded-[16px] p-8 transition-all hover:border-[rgba(255,255,255,0.1)]">
            ...
            <p className="text-[15px] text-white/70 leading-[1.7]">
              Existing tools require manual entry or bank linking. In the Philippines, banks restrict third-party integrations, and users are hesitant to share credentials. This creates a gap no app has fully solved.
            </p>
          </div>
          <div className="bg-[#0A2540] rounded-[16px] p-8 transition-all hover:border-[rgba(255,255,255,0.1)]">
            <div className="font-landing-title text-[48px] font-bold text-[#14B8A6] leading-none mb-4">
