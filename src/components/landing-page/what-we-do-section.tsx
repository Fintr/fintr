...
export default function WhatWeDoSection() {
  return (
    <section className="landing-section-y bg-[#FAF9F7]">
      <div className="max-w-[1200px] mx-auto px-6 sm:px-10 lg:px-12">
        ...
        <p className="text-[15px] text-[#57534E] max-w-[800px] leading-[1.8]">
          In the Philippines, banks are restrictive about third-party app integrations, and users are cautious about sharing their account credentials. Fintr removes that friction entirely. Using receipt scanning and AI-driven analysis, you can track every transaction without connecting your bank. The AI assistant answers your money questions, generates monthly financial summaries, and helps you understand where your money goes, so you can make informed decisions instead of relying on instinct.
        </p>
      </div>
    </section>
  );
