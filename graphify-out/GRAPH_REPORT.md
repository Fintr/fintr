# Graph Report - fintr  (2026-09-24)

## Corpus Check
- 2369 files · ~1,321,806 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 18110 nodes · 44579 edges · 953 communities (715 shown, 238 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 1338 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `683bfe0e`
...
- useImport.ts
- Api::V1::Ai::ConversationsController
- design-parser.mjs
- (private)/layout.tsx
- detail-local.ts
- Intent
...
- MonthlyFinancialSummaries::Queries::TotalsInSpaceForRange
...
- Transactions::Operations::Accounts::ShowAccounts
...
- agent/skills/wireframe/references/viewer.js
...
- Imports::Operations::PrepareCategories
...
- serve-question.mjs
- ExchangeRates::Operations::PersistApiRates
...
- Api::V1::Goals::DescriptionsController
- model_registry.rb
...
- .show
- Api::V1::Transactions::TransfersController
- .run
- Crm
...
- Api::V1::Finance::ProGrantAcknowledgementsController
...
- IncreaseApiExchangeRatesRatePrecision
- AddCurrencyToOnboardingSteps
- AddAdjustsAccountBalanceToLoanPayments
- compilerOptions
- CreateAccountActivities
- UpdateCombinedTransactionsToVersion3
- UpdateAccountActivitiesToVersion2
- RefreshAccountActivitiesView
- AddFxFieldsToMonthlyFinancialSummaries
- RenameDisplayCurrencyToCurrencyOnMonthlyFinancialSummaries
- migrate-staging-to-timescaledb.sh
...
- CreateBudgets
- AddDiscardedAtToAccounts
- CreateGoalDescriptions
- CreateOnboardings
- CreateCrmTickets
- CreateCrmTicketResponses
- RemoveBetaWhitelists
- adaptiveIcon
- UpdateCombinedTransactionsToVersion2
- AddInvitationFieldsToSpaceUsers
- UpdateExistingSpaceUsersInvitationStatus
- CreateUserActivities
- MakeUserIdNullableInSpaceUsers
...
- CreateLoanPayments
- fintr-be/README.md
- Api::V1::Achievements::AchievementsController
- CreateFinanceSubscriptionPlans
- CreateFinanceSpaceSubscriptions
- Appendix G — Sync coordinator
- AddXenditCustomerToSpaces
- CreateFinancePayments
- AddTutorialFieldsToUsers
- CreateCurrencyConversions
- CreateApiExchangeRates
- AddDefaultTransactionCurrencyToSpaces
- AddInvitationSeenAtToSpaceUsers
- AddOwnerIdToSpaces
- CreateSponsorCodeTables
- AddDiscountMonthsToSponsorCodes
...
- scripts
- MJ Rathbun AI Bot
- generate-ios-splash.sh
- reset-ios-packages.sh
- transferAtoms.ts
...
- UpdateCombinedTransactionsToVersion5
- UpdateAccountActivitiesToVersion4
- Fintr
- postcss.config.mjs
...
- Api::V1::Transactions::LoansController
- Entities::Entity
- filterFindings
- live-inject.mjs
...
- Matplotlib AI Agent Incident by Miko
...
- AssignInitialAdmins
- ChangeCentsFieldsToBigint
- ResetCombinedTransactionsViewAndCleanupRemovedMigrations
- SwitchActiveStorageBlobsToGoogle
- Appendix E — Operation catalog
- Transactions::Operations::ResolveCategoryByName
- sentry-example-page/page.tsx
- insights-tab.pro-access.test.tsx
...
- Api
- ApplicationMailer
- usePrefetchDashboardNavRoutes.test.ts
- usePrefetchDetailHrefs.test.ts
- Api::V1::BudgetsController
- unauthorized-session.test.ts
...
- CreateTransactionsCategories
- CreateAccounts
- CreateCombinedTransactions
- CreateAiUsage
- CreateMonthlyFinancialSummaries
- CreateEntities
- CreateLoans
- CreateImports
- CreateImportRecords
- CreateFinanceBillingCycles
- CreateProductPulseFeedbacks
- AddAdjustsAccountBalanceToLoans
- AddSubcategoriesToCategoriesTransactionsBudgets
- CreateSolidQueueTables
- capacitor.config.ts
- fintr-fe/instrumentation.ts
- sentry-fintr
- docker-entrypoint
...
- Api::V1::Finance::ProAccessController
- Api::V1::Finance::RevenuecatSyncController
- sonner
- Api::V1::Imports::SampleTemplatesController
- next-dev-memory-config.test.ts
- AGENTS.md
- expo-constants
- expo-font
- expo-linking
...
- tailwind-merge
- Api::V1::Transactions::DraftsController
- playwright.config.ts
- build-android-aab.sh
- build-android-apk.sh
- check-ios-signing.sh
- verify-build-env.sh
- ProductPulse::Serializers::FeedbackSerializer
- realtime-actor-toast.tsx
- Spaces::Serializers::DashboardSerializer
- insight-narrative-cards.tsx
- autoFxRateSelection.ts
- loanContactOutstanding.ts
- Budgets::Queries::BaseQuery
- Entities::Serializers::EntityDetailSerializer
- Entities::Serializers::MerchantAliasSerializer
- Spaces::Serializers::SpaceUserSerializer
- Api::V1::Entities::IdentifiersController
- InsightsEndpoint
- Transactions
- Transactions
- AddSubscriptionSnapshotToRevenuecatCustomers
- CreateFinanceProGrants
- Api
- Sync
- Entities
- circle-flags
...
- `initializeOnDeviceLlm()` --indirect_call--> `error()`  [INFERRED]
  apps/fintr-fe/src/lib/on-device-llm/client.ts → .ai/get-shit-done/bin/lib/core.cjs
- `resyncTransactionRelationIdsIfNeeded()` --indirect_call--> `error()`  [INFERRED]
  apps/fintr-fe/src/services/local-sync/bootstrap-local-data.ts → .ai/get-shit-done/bin/lib/core.cjs
...
## Communities (953 total, 238 thin omitted)

### Community 0 - "button.tsx"
Cohesion: 0.02
Nodes (209): AiInteractionsPage(), UserAnalyticsPage(), PRO_GRANTS_QUERY_KEY, UsersPage(), AdminWeeklyCheckInPage(), formatAreaInline(), CreateTicketForm, CreateTicketFormProps (+201 more)

### Community 1 - "transaction-detail-content.tsx"
Cohesion: 0.03
Nodes (141): RecurringPage(), AreaChartComponent(), BarChartComponent(), ChartComponent(), ChartComponentProps, LineChartComponent(), PieChartComponent(), AccountBreakdownComponent() (+133 more)

### Community 2 - "cn"
Cohesion: 0.01
Nodes (196): AdminLayout(), AdminLayoutProps, AccountSetupFlow(), AccountEditSheet(), AccountEditSheetProps, AccountIconBadge(), AccountIconBadgeProps, sizeClasses (+188 more)

### Community 3 - "transactions/index.tsx"
Cohesion: 0.02
Nodes (172): page(), page(), Layout(), page(), page(), SpaceTestPage(), pendingDashboardBottomTabAtom, dateRangeToMonthYear() (+164 more)

### Community 4 - "loans/local-cache.ts"
Cohesion: 0.03
Nodes (129): offlineSyncReadyAtom, DeleteLoanModalProps, EditLoanModalProps, mockLoan, { mockPayments }, fetchLoansPage, fetchLoanById, { fetchLoanPayments, createLoanPayment } (+121 more)

### Community 5 - "Transactions::Loan"
Cohesion: 0.04
Nodes (13): Achievements, Achievements::Qualifiers, Versionable, Transactions, Transactions::LoanPayment, Transactions, Transactions::Loan, ExchangeRates (+5 more)
...
### Community 7 - "planningDir"
Cohesion: 0.07
Nodes (93): cmdCheckCommit(), cmdCommit(), cmdCurrentTimestamp(), cmdGenerateSlug(), cmdHistoryDigest(), cmdListTodos(), cmdProgressRender(), cmdResolveModel() (+85 more)

### Community 8 - "transactionTypes.ts"
Cohesion: 0.02
Nodes (186): pendingOpenTransactionAtom, EditTransactionDialogProps, IncomeFormProps, gbpConvertedIncome, { mockIncomeCategoryOptions }, phpOnlyAccounts, accountOptions, baseInitialData (+178 more)

### Community 9 - "error"
Cohesion: 0.06
Nodes (103): error(), ConsentPage(), EditAccountDialog(), { fetchTransactionTags, createTransactionTag }, useTransactionTags(), removeOutboxRecord(), updateOutboxStatus(), putSpaceTransactions() (+95 more)

### Community 10 - "checks.mjs"
Cohesion: 0.03
...
### Community 11 - "output"
Cohesion: 0.07
Nodes (79): cmdSummaryExtract(), setConfigValue(), atomicWriteFileSync(), escapeRegex(), extractOneLinerFromBody(), normalizeMd(), output(), replaceInCurrentMilestone() (+71 more)

### Community 12 - "pro-plan-card.tsx"
Cohesion: 0.03
Nodes (79): ProGrantsPage(), api, CreateSubscriptionPage(), WizardStep, OnboardingIndex(), AuthToggle(), UnifiedAuthPage(), UnifiedAuthPageProps (+71 more)

### Community 13 - "convert-local-first.ts"
Cohesion: 0.06
Nodes (79): ConvertCategoryDialog(), enqueueOutboxRecord(), isNetworkLikeMutationError(), readBrowserOnline(), applyCategoryCreated(), applyCategoryDeleted(), applyCategoryUpdated(), asString() (+71 more)

### Community 14 - "insights/types.ts"
Cohesion: 0.12
Nodes (27): AccountBreakdownProps, DashboardSummarySectionProps, WeeklySpendingCardProps, fetchInsightsAccountBreakdown(), fetchInsightsExpenseBreakdown(), fetchInsightsMonthlySpending(), fetchInsightsSummary(), InsightsData (+19 more)

### Community 15 - "transactions/local-cache.ts"
Cohesion: 0.04
Nodes (110): shouldFetchNextInfinitePage(), loadEntryTypeFallbackRows(), pagesAreLoaded(), { mockUseAuthApi }, useInfiniteTransactions(), countSpaceTransactions(), listSpaceTransactions(), listSpaceTransactionsInDateRange() (+102 more)

### Community 16 - "insights-tab.tsx"
Cohesion: 0.06
Nodes (62): page(), categoryOptionsAtom, dashboardDataAtom, dashboardShellReadyAtom, isAdminAtom, dateFilterEndDateAtom, dateFilterMonthYearAtom, dateFilterStartDateAtom (+54 more)

### Community 17 - "category-detail-content.tsx"
Cohesion: 0.04
Nodes (71): page(), LoanDetailInner(), LoanDetailPage(), mockSearchParamGet, RecurringDetailInner(), RecurringDetailPage(), AccountDetailInner(), AccountDetailPage() (+63 more)

### Community 18 - "useSubscriptions.ts"
Cohesion: 0.06
...
### Community 20 - ".render_success"
Cohesion: 0.03
Nodes (19): Api::V1::ExchangeRatesController, ApiController, Api::V1::Transactions::AccountsController, ApiController, Api::V1::Transactions::CategoriesController, ApiController, Api::V1::TransactionsController, ApiController (+11 more)

### Community 21 - "(public)/page.tsx"
Cohesion: 0.05
...
### Community 22 - "GridPicker.tsx"
Cohesion: 0.03
Nodes (141): buildBudgetCategoryFromParent(), CategoryBudgetSection(), CategoryBudgetSectionProps, hasBudgetForMonth(), AmountWithRatePickerProps, CategoryCreationForm(), accountBalanceColorClass(), defaultDataTestId() (+133 more)

### Community 23 - ".render_not_found"
Cohesion: 0.04
Nodes (33): Api, Api::V1, Api::V1::Crm, Api::V1::Crm::TicketResponsesController, ApiController, Api, Api::V1, Api::V1::Imports (+25 more)

### Community 24 - "svelte-component.mjs"
Cohesion: 0.06
...
### Community 25 - "Auth::Operations::ExchangeGoogleCode"
Cohesion: 0.09
Nodes (14): Api, Api::V1, Api::V1::Auth, Api::V1::Auth::GoogleController, ApiController, Api, Api::V1, Api::V1::Auth (+6 more)

### Community 26 - "modern-screenshot.umd.js"
Cohesion: 0.09
Nodes (52): ae(), be(), bt(), Ce(), Ct(), de(), dt(), _e() (+44 more)

### Community 27 - "account-cache-ops.ts"
Cohesion: 0.06
Nodes (65): DeleteAccountDialogProps, EditAccountDialogProps, seedPhpAccounts(), appendAccountPreviousName(), accountCacheKey(), clearSpaceAccounts(), getAccountsSyncedAt(), listSpaceAccounts() (+57 more)

### Community 28 - "config.cjs"
Cohesion: 0.10
...
### Community 29 - "useAuthApi"
Cohesion: 0.03
Nodes (149): accountValidationErrorsAtom, createAccountAtom, CreateAccountParams, newAccountBalanceAtom, newAccountNameAtom, validateBalance(), AccountDeleteDialog(), account (+141 more)

### Community 30 - "exchangeRates/queries.ts"
Cohesion: 0.13
Nodes (36): ExchangeRateSelectorContentProps, ExchangeRateSelectorSheetProps, buildCurrencyPairs(), cacheCurrentExchangeRate(), cacheRecentExchangeRates(), clearCachedCurrentExchangeRate(), currentRateKey(), isValidCachedCurrentRate() (+28 more)

### Community 31 - "connectSSE"
Cohesion: 0.06
...
### Community 32 - "bootstrap-local-data.ts"
Cohesion: 0.03
Nodes (199): getInitialOfflineReimportRequired(), getInitialOfflineSyncReady(), offlineReimportRequiredAtom, useDashboardData(), UseDashboardDataOptions, getPersistedSpaceCode(), useHydrateOfflineSyncReady(), catchUpMonthlyBudgetsForSpace() (+191 more)

### Community 33 - "Ai::Rag::Agent::ResponseFallbackBuilder"
Cohesion: 0.16
...
### Community 36 - "dashboard-nav-routes.ts"
Cohesion: 0.07
Nodes (38): mockUsePathname, useDashboardPathname(), mockUsePathname, usePendingDashboardBottomTab(), MAX_CACHED_BOTTOM_NAV_SCREENS, nextCachedBottomNavTabs(), committedPathnameListeners, DASHBOARD_BOTTOM_NAV_ROUTES (+30 more)

### Community 37 - "live-server.mjs"
Cohesion: 0.06
...
Cohesion: 0.04
Nodes (48): devDependencies, dotenv-cli, eruda, eslint, eslint-config-next, @eslint/eslintrc, fake-indexeddb, jsdom (+40 more)

### Community 40 - "Transactions::Operations::CreateRepeatTransactions"
Cohesion: 0.06
...
Cohesion: 0.04
Nodes (56): dependencies, @ariakit/react, axios, @capacitor/android, @capacitor/app, @capacitor/ios, @capgo/capacitor-llm, @daypicker/react (+48 more)

### Community 42 - "async/useOnboarding.ts"
Cohesion: 0.08
Nodes (31): AccountCategory, AccountData, appliedBudgetFiltersAtom, budgetCategoriesAtom, budgetDateAtom, budgetStatsAtom, IncomeRequirements, incomeRequirementsAtom (+23 more)

### Community 43 - "design-system.mjs"
Cohesion: 0.07
...
### Community 44 - "calculator-input.tsx"
Cohesion: 0.14
...
### Community 45 - "entities/local-cache.ts"
Cohesion: 0.05
Nodes (64): apiPost, { fetchEntities, createEntity }, store, fetchEntityDetail, buildOptimisticEntity(), createEntityLocalFirst(), CreateEntityLocalFirstOptions, CreateEntityLocalFirstResult (+56 more)

### Community 46 - "Auth::Operations::RegisterUser"
Cohesion: 0.07
...
### Community 47 - "impeccable-paths.mjs"
Cohesion: 0.06
Nodes (56): resolveProjectRoot(), CRITIQUE_DIR, firstExisting(), getDesignSidecarCandidates(), getDesignSidecarPath(), getImpeccableDir(), getLegacyLiveAnnotationsDir(), getLegacyLiveConfigPath() (+48 more)

### Community 48 - "hook-before-edit.mjs"
Cohesion: 0.12
Nodes (36): allow(), bumpCursorDenial(), cursorBlockMessage(), deny(), detectProposedHtml(), done(), escapeRegExp(), findingSignature() (+28 more)

### Community 49 - "profile-output.cjs"
Cohesion: 0.09
...
### Community 55 - "expense-breakdown-card.tsx"
Cohesion: 0.06
Nodes (43): AddReceiptDialog(), AddReceiptDialogProps, canOfferCameraCapture(), fileLooksLikeImage(), FileUploadField(), FileUploadFieldProps, ExpenseBreakdownCard(), ExpenseBreakdownCardProps (+35 more)

### Community 56 - "Transactions::Transfer"
Cohesion: 0.05
...
### Community 58 - "Transactions::Operations::Accounts::SaveAccount"
Cohesion: 0.07
Nodes (21): Imports, Imports::Operations, Imports::Operations::Accounts, Imports::Operations::Accounts::FindOrCreateImportAccount, Imports::Operations::Accounts::FindOrCreateImportAccount::Contract, Contract, Operation, Contract (+13 more)

### Community 59 - "Crm::Ticket"
Cohesion: 0.07
Nodes (15): Crm, Crm::Ticket, Crm, Crm::Operations, Crm::Operations::Admin, Crm::Operations::Admin::UpdateTicketStatus, Crm::Operations::Admin::UpdateTicketStatus::Contract, Contract (+7 more)

### Community 60 - "Transactions::Operations::CreateTransaction"
Cohesion: 0.08
...
### Community 63 - "transactions/create-local-first.ts"
Cohesion: 0.03
Nodes (150): asNumber(), asString(), asType(), handleRealtimeMessage(), normalizeRealtimeIndexTransaction(), optionalIndexId(), parseRealtimeTransactionTags(), pickField() (+142 more)

### Community 64 - "concept-seed.mjs"
Cohesion: 0.08
Nodes (48): API_BASE, API_TIMEOUT_MS, apiBudgetMs(), dealCompositions(), driveSelection(), fetchRoll(), here, loadLocal() (+40 more)

### Community 65 - "initPageChat"
Cohesion: 0.08
...
### Community 66 - "loan-upcoming-deadlines.ts"
Cohesion: 0.14
Nodes (23): HomeLoansSection(), HomeSection(), HomeSectionProps, DeadlineSection(), DeadlineSectionProps, formatDueDate(), LoanUpcomingSectionsProps, compareActiveLoansByNextDueDate() (+15 more)

### Community 67 - "AuthContext.tsx"
Cohesion: 0.08
Nodes (39): AuthCallbackInner(), isIOSDevice(), mockAssign, mockPush, mockReplace, mockUseAuth, DeepLinkHandler(), processedAuthCallbackUrls (+31 more)

### Community 68 - "compilerOptions"
Cohesion: 0.05
Nodes (42): compilerOptions, allowJs, esModuleInterop, incremental, isolatedModules, jsx, lib, module (+34 more)

### Community 69 - "Finance::SponsorCode"
Cohesion: 0.09
...
### Community 70 - "Api::V1::Spaces::UsersController"
Cohesion: 0.25
Nodes (5): Api, Api::V1, Api::V1::Spaces, Api::V1::Spaces::UsersController, ApiController

### Community 71 - "FailureHandler"
Cohesion: 0.06
...
### Community 72 - "Finance::Operations::PaymentSessions::Webhooks::HandlePaymentSessionSucceeded"
Cohesion: 0.11
...
### Community 73 - "MonthlyFinancialSummary"
Cohesion: 0.11
...
### Community 74 - "Ai::Operations::Receipts::ExtractReceiptDataVision"
Cohesion: 0.11
...
### Community 78 - "local-db/index.ts"
Cohesion: 0.05
Nodes (79): convertCategoryHierarchy, trees, { fetchTransactionCategories, createTransactionCategory }, appliedSeqsKey(), AppliedSeqsMeta, getAppliedSeqsMeta(), isSeqApplied(), markSeqApplied() (+71 more)

### Community 79 - "core.cjs"
Cohesion: 0.06
...
### Community 80 - "live-manual-edit-evidence.mjs"
Cohesion: 0.16
...
### Community 82 - "Spaces::Space"
Cohesion: 0.09
Nodes (11): Channel, TransactionsChannel, ApplicationRecord, Spaces, Spaces::Space, Contract, Operation, Spaces (+3 more)

### Community 83 - "Finance::Operations::Subscriptions::UpdateSubscription"
Cohesion: 0.13
Nodes (7): Finance, Finance::Operations, Finance::Operations::Subscriptions, Finance::Operations::Subscriptions::UpdateSubscription, Finance::Operations::Subscriptions::UpdateSubscription::Contract, Contract, Operation

### Community 84 - "useAiChat.ts"
Cohesion: 0.11
Nodes (38): useAiChat(), useAiLlmPriority(), ensureChatSession(), getOnDeviceLlmReadiness(), initializeOnDeviceLlm(), loadCapgoLlm(), mapReadiness(), nativeCapgoLlmInstalled() (+30 more)

### Community 85 - "Transactions::Queries::FilteredCombined"
Cohesion: 0.06
...
### Community 86 - "Integrations::Marketing::Brevo::Client"
Cohesion: 0.13
...
### Community 88 - "impeccable-config.mjs"
Cohesion: 0.10
Nodes (47): applyDetectionConfigSource(), clampByte(), cleanIgnoreValueDisplay(), cloneDetectionConfig(), cloneRawDetectionConfig(), colorIgnoreKey(), DEFAULT_DETECTION_CONFIG, DETECTOR_CONFIG_KEYS (+39 more)

### Community 89 - "useCountUp.ts"
Cohesion: 0.60
Nodes (3): easeOutCubic(), useCountUp(), UseCountUpOptions

### Community 90 - "intel.cjs"
Cohesion: 0.16
Nodes (21): crypto, disabledResponse(), ensureIntelDir(), fs, hashFile(), INTEL_FILES, intelDiff(), intelFilePath() (+13 more)

### Community 91 - "Auth::Operations::SyncUserFromAuthToken"
Cohesion: 0.09
...
### Community 92 - ".format_percentage"
Cohesion: 0.17
Nodes (6): Insights, Insights::Operations, Insights::Operations::CreateHealthScores, Insights::Operations::CreateHealthScores::Contract, Contract, Operation
...
### Community 94 - "Entities::Operations::UpsertMerchantAlias"
Cohesion: 0.10
...
### Community 96 - "generate_review.py"
Cohesion: 0.15
...
### Community 97 - "Finance::Operations::Revenuecat::SyncCustomer"
Cohesion: 0.14
...
### Community 99 - ".render_error"
Cohesion: 0.04
Nodes (23): ApiController, Api, Api::V1, Api::V1::AttachmentsController, Api, Api::V1, Api::V1::Auth, Api::V1::Auth::LoginController (+15 more)

### Community 100 - "live-wrap.mjs"
Cohesion: 0.13
...
### Community 102 - "Transactions::Operations::Loans::CreateLoan"
Cohesion: 0.10
...
### Community 103 - "Insights::Operations::CreateNarratives"
Cohesion: 0.13
Nodes (4): Insights::Operations::CreateNarratives, Insights::Operations::CreateNarratives::Contract, Contract, Operation

### Community 104 - "Ai::Operations::Receipts::ResolveSuggestedTransactionPayload"
Cohesion: 0.18
...
### Community 105 - "Insights::Operations::CreateWeeklySpending"
Cohesion: 0.11
...
### Community 106 - "Transactions::Operations::Transfers::UpdateTransfer"
Cohesion: 0.08
...
### Community 108 - "Finance::Operations::Entitlements::ResolveProAccess"
Cohesion: 0.07
Nodes (19): Api, Api::V1, Api::V1::Ai, Api::V1::Ai::UsagesController, ApiController, Ai, Ai::Operations, Ai::Operations::Usages (+11 more)

### Community 109 - "detect-antipatterns.mjs"
Cohesion: 0.12
...
### Community 111 - "extractFrontmatter"
Cohesion: 0.06
...
### Community 112 - "Auth::Operations::UpdateUserAuth0"
Cohesion: 0.12
...
### Community 113 - "manual-apply.mjs"
Cohesion: 0.10
Nodes (36): addOpToManualApplyChunk(), APPLY_EVENT_HARD_TIMEOUT_MS, APPLY_EVENT_SOFT_DEADLINE_MS, buildManualApplyAgentAction(), clearManualApplyTransaction(), collectManualApplyFiles(), compactManualApplyBatch(), compactManualApplyCandidates() (+28 more)

### Community 114 - "Transactions::Operations::Transfers::CreateTransfer"
Cohesion: 0.06
...
### Community 115 - "useImport.ts"
Cohesion: 0.08
Nodes (34): ImportRecordEditor(), ImportWizard(), useCreateImport(), useDownloadSampleTemplate(), useImport(), useImportRecords(), useImports(), useImportSingleRecord() (+26 more)

### Community 116 - "Api::V1::Ai::ConversationsController"
Cohesion: 0.15
Nodes (9): Api, Api::V1, Api::V1::Ai, Api::V1::Ai::ConversationsController, ApiController, Ai, Ai::Serializers, Ai::Serializers::ConversationSerializer (+1 more)

### Community 117 - "design-parser.mjs"
Cohesion: 0.13
...
### Community 118 - "(private)/layout.tsx"
Cohesion: 0.11
Nodes (28): PrivateLayout(), PrivateShellReadyMarker(), AuthWrapper(), AuthWrapperProps, CapacitorLoadingTimeout(), CapacitorLoadingTimeoutProps, MobileStickyHeader(), MaintenanceScreen() (+20 more)

### Community 119 - "detail-local.ts"
Cohesion: 0.05
Nodes (99): getLocalDb(), attachmentOwnerTypeForTransaction(), blobFromProxyResponse(), blobLooksLikeJsonError(), cacheRemoteFilesForOwner(), cacheRemoteFilesForOwners(), fetchAttachmentBlob(), assertAttachmentSize() (+91 more)

### Community 120 - "Intent"
Cohesion: 0.05
...
### Community 121 - "Api::V1::Admin::CachesController"
Cohesion: 0.25
Nodes (5): Api, Api::V1, Api::V1::Admin, Api::V1::Admin::CachesController, ApiController

### Community 122 - "ApplicationJob"
Cohesion: 0.04
Nodes (27): ApplicationJob, Base, Budgets, Budgets::CreateMonthlyBudgetsJob, Budgets, Budgets::CreateSpaceMonthlyBudgetsJob, ExchangeRates, ExchangeRates::BackfillRatesForTransactionsJob (+19 more)

### Community 123 - "Transactions::Operations::BulkRecordTransactionVersions"
Cohesion: 0.13
...
### Community 124 - "MonthlyFinancialSummaries::Queries::TotalsInSpaceForRange"
Cohesion: 0.11
...
### Community 125 - "Transactions::Operations::UpdateTransaction"
Cohesion: 0.07
...
### Community 126 - "organize/SKILL.md"
Cohesion: 0.08
...
### Community 127 - "injected/index.mjs"
Cohesion: 0.08
...
### Community 128 - "Finance::Operations::Customers::CreateCustomer"
Cohesion: 0.11
...
### Community 129 - "Ai::Queries::Usages::UsageInPeriod"
Cohesion: 0.21
Nodes (7): Ai, Ai::Queries, Ai::Queries::Usages, Ai::Queries::Usages::UsageInPeriod, Ai::Queries::Usages::UsageInPeriod::Contract, Contract, Operation

### Community 130 - "Finance::Operations::Subscriptions::CreateSubscription"
Cohesion: 0.16
...
### Community 131 - "Finance::Operations::Subscriptions::Webhooks::HandleCycleSucceeded"
Cohesion: 0.15
...
### Community 132 - "Transactions::Operations::Accounts::ShowAccounts"
Cohesion: 0.13
Nodes (12): Contract, Operation, Transactions, Transactions::Operations, Transactions::Operations::Accounts, Transactions::Operations::Accounts::ShowAccounts, Transactions::Operations::Accounts::ShowAccounts::Contract, Base (+4 more)

### Community 133 - "Transactions::Operations::Loans::UpdateLoanPayment"
Cohesion: 0.10
...
### Community 134 - "src/index.ts"
Cohesion: 0.07
Nodes (47): assertDeleteTransactionForOptimistic(), INSTALLMENT_REVISION_ANCHORS, InstallmentPlanRevisionInput, InstallmentPlanRevisionResult, InstallmentRevisionAnchor, DELETE_SCOPES, DeleteScope, EXCHANGE_RATE_SOURCES (+39 more)
...
### Community 136 - "setAuthStorageForE2e"
Cohesion: 0.16
Nodes (13): buildTestIdToken(), applyAndroidThreeButtonNavClasses(), openAddTransactionCalculator(), openExpenseForm(), buildTestJwt(), emptyListResponse, mockCommonDashboardApi(), setAuthStorageForE2e() (+5 more)

### Community 137 - "Sync::Operations::BootstrapSpace"
Cohesion: 0.14
Nodes (6): Sync, Sync::SpaceSequence, Contract, Operation, Sync::Operations::BootstrapSpace, Sync::Operations::BootstrapSpace::Contract

### Community 138 - "lib/api.ts"
Cohesion: 0.26
Nodes (9): apiClient, AUTH_BOOTSTRAP_PATHS, createAuthenticatedClient(), handleResponseError(), hasFreshAuthSession(), isAuthBootstrapRequest(), SESSION_EXPIRED_EVENT_NAME, triggerSessionExpiration() (+1 more)

### Community 139 - "useGetSpaceCode.ts"
Cohesion: 0.17
...
### Community 141 - "Finance::SpaceSubscription"
Cohesion: 0.08
...
### Community 142 - "Finance::Operations::Subscriptions::Webhooks::HandleCycleFailed"
Cohesion: 0.16
Nodes (8): Finance, Finance::Operations, Finance::Operations::Subscriptions, Finance::Operations::Subscriptions::Webhooks, Finance::Operations::Subscriptions::Webhooks::HandleCycleFailed, Finance::Operations::Subscriptions::Webhooks::HandleCycleFailed::Contract, Contract, Operation

### Community 143 - "Publishing Fintr to the App Store"
Cohesion: 0.06
...
### Community 144 - "Transactions::Operations::DeleteThisTransaction"
Cohesion: 0.04
...
### Community 145 - "ensure-monthly-budgets-local-first.ts"
Cohesion: 0.06
Nodes (81): useBudgetsData(), addParentBudgetRowToPage(), applyBudgetsPageToCaches(), BudgetLocation, findBudgetLocation(), getBudgetRows(), loadBudgetsPage(), removeBudgetRowFromPage() (+73 more)

### Community 146 - "applyEditing"
Cohesion: 0.09
...
### Community 149 - "insight-metric-cards.tsx"
Cohesion: 0.08
...
### Community 150 - "create-expense-with-cost-share-local-first.ts"
Cohesion: 0.12
Nodes (27): CreateLoanLocalFirstResult, buildAllocationInput(), COST_SHARE_LOAN_TERM_MONTHS, costShareLoanDescription(), CreateExpenseWithCostShareLocalFirstResult, CreateExpenseWithCostShareParams, ExpenseCostShareInput, CreateTransactionLocalFirstOptions (+19 more)

### Community 151 - "Api::V1::Transactions::LoanPaymentsController"
Cohesion: 0.14
...
### Community 152 - "live-copy-edit-agent.mjs"
Cohesion: 0.14
...
### Community 153 - "Finance::Queries::SubscriptionsNeedingCycleCountUpdate"
Cohesion: 0.14
...
### Community 156 - "Ai::Operations::Receipts::FormatResult"
Cohesion: 0.14
Nodes (7): Ai, Ai::Operations, Ai::Operations::Receipts, Ai::Operations::Receipts::FormatResult, Ai::Operations::Receipts::FormatResult::Contract, Contract, Operation

### Community 157 - "ExchangeRates::Operations::FetchRate"
Cohesion: 0.22
...
### Community 158 - "Finance::Operations::Subscriptions::CalculateProration"
Cohesion: 0.17
Nodes (7): Finance, Finance::Operations, Finance::Operations::Subscriptions, Finance::Operations::Subscriptions::CalculateProration, Finance::Operations::Subscriptions::CalculateProration::Contract, Contract, Operation

### Community 159 - "Blueprint — Map the System"
Cohesion: 0.07
Nodes (29): 1. Service blueprinting, 2. Ecosystem & dependency mapping, 3. Process architecture, 4. System state & failure mode analysis, 5. Scalability & evolution planning, 6. Decision documentation, Ask first, Blueprint — Map the System (+21 more)

### Community 160 - "Accessibility Foundations"
Cohesion: 0.07
Nodes (29): Accessibility Foundations, Aging, Assistive Technology Landscape, Cognitive Accessibility, Consistent Patterns, Error Prevention, Focus Management, Inclusive Design Beyond Disability (+21 more)

### Community 161 - "Wireframe"
Cohesion: 0.07
...
### Community 162 - "transactions/delete-local-first.ts"
Cohesion: 0.11
Nodes (42): CREATE_OUTBOX_COMMANDS, purgeAttachmentsForLocalCreate(), purgeAttachmentsForTransactions(), adjustSummariesForRemoved(), cancelPendingLocalCreate(), deleteIndexRowsOptimistic(), deleteTransactionLocalFirst(), DeleteTransactionLocalFirstOptions (+34 more)

### Community 163 - "frameworks/index.mjs"
Cohesion: 0.14
...
### Community 164 - "Ai::Interaction"
Cohesion: 0.13
Nodes (8): Api, Api::V1, Api::V1::Admin, Api::V1::Admin::Ai, Api::V1::Admin::Ai::AiInteractionsController, ApiController, Ai, Ai::Interaction

### Community 165 - ".render_paginated"
Cohesion: 0.05
Nodes (21): Api, Api::V1, Api::V1::Admin, Api::V1::Admin::Finance, Api::V1::Admin::Finance::FreeSubscriptionsController, ApiController, Api, Api::V1 (+13 more)

### Community 166 - "Ai::Providers::ResilientProvider"
Cohesion: 0.15
Nodes (7): Ai, Ai::Providers, Ai::Providers::ProviderFactory, Ai::Providers::ResilientProvider, create(), create_with_fallback(), BaseProvider

### Community 167 - "Ai::Rag::QueryBuilder"
Cohesion: 0.14
Nodes (11): Ai, Ai::Rag, Ai::Rag::QueryBuilder, Ai, Ai::Rag, Ai::Rag::TopicFilter, apply(), apply_to_embeddings() (+3 more)

### Community 168 - "UserActivity"
Cohesion: 0.07
...
### Community 172 - "Imports::Operations::ImportSingleRecord"
Cohesion: 0.19
...
### Community 173 - "Insights::Operations::ResolveContext"
Cohesion: 0.19
...
### Community 174 - "Transactions::Operations::Accounts::UpdateCalculateBalance"
Cohesion: 0.18
...
### Community 175 - "Transactions::Operations::Loans::CreateLoanPayment"
Cohesion: 0.12
...
### Community 176 - "from-monthly-buckets.ts"
Cohesion: 0.16
...
### Community 177 - "verify.cjs"
Cohesion: 0.08
Nodes (32): cmdCommitToSubrepo(), checkAgentsInstalled(), execGit(), getAgentsDir(), cmdDocsInit(), detectDocTooling(), detectMonorepoWorkspaces(), detectProjectType() (+24 more)

### Community 178 - "Per-space change log sync (FIN-196)"
Cohesion: 0.06
Nodes (33): Appendix A — Rails migration DDL, Architecture, Batched ops, Change log schema (backend), Change record shape (API + cable), Comparison summary, Decision, Decision (v1) (+25 more)

### Community 179 - "Interaction Patterns"
Cohesion: 0.07
Nodes (26): Anti-Patterns in Progressive Disclosure, Button States, Design Principles for Undo, Destructive Action Safeguards, Error Message Design, Feedback Loops, Field Grouping, Form Design Principles (+18 more)

### Community 180 - "gap-checker.cjs"
Cohesion: 0.20
...
### Community 181 - "Onboardings::Operations::ShowAccountsData"
Cohesion: 0.10
...
### Community 182 - ".perform"
Cohesion: 0.21
Nodes (4): Ai, Ai::ChatBroadcaster, Ai, Ai::AiChatJob

### Community 183 - "account-balance-chart.tsx"
Cohesion: 0.19
...
### Community 184 - "Finance::ProGrant"
Cohesion: 0.07
...
### Community 185 - "offline-calculations.ts"
Cohesion: 0.04
Nodes (101): EMPTY_NARRATIVES, INSIGHTS_LOCAL_QUERY_OPTIONS, InsightsCategoryOptions, insightsFiltersAreActive(), isLocalInsightsQueryLoading(), mergeUnfilteredInsightsBundle(), readPersistedSpaceCode(), useInsightsQueries() (+93 more)

### Community 186 - "handleManualEditActivity"
Cohesion: 0.17
...
### Community 187 - "getPublicBackendUrl"
Cohesion: 0.17
...
### Community 188 - "Transactions::Queries::FilteredAccountActivities"
Cohesion: 0.07
Nodes (17): Transactions, Transactions::Queries, Transactions::Queries::AccountActivityCategoryFilter, Transactions, Transactions::Queries, Transactions::Queries::AccountActivityTotalsByType, Transactions, Transactions::Queries (+9 more)

### Community 189 - "useTickets.ts"
Cohesion: 0.14
...
### Community 190 - "Finance::Operations::Subscriptions::ForceAttemptCycle"
Cohesion: 0.18
...
### Community 192 - "Mobile layout tests"
Cohesion: 0.08
...
### Community 193 - "Measure — Define and Track Success"
Cohesion: 0.08
Nodes (25): 1. Metric selection: HEART framework, 2. Goal-Signal-Metric mapping, 3. A/B test design, 4. Funnel analysis, 5. Qualitative and quantitative triangulation, 6. Ethical measurement, A/B test plan template, Core capabilities (+17 more)

### Community 194 - "Imports::Operations::GenerateSampleTemplate"
Cohesion: 0.18
...
### Community 196 - "Spaces::Operations::TransferOwnership"
Cohesion: 0.19
...
### Community 197 - "Transactions::Operations::Accounts::AdjustAccountBalance"
Cohesion: 0.18
...
### Community 198 - "Transactions::Operations::Categories::ConvertCategoryHierarchy"
Cohesion: 0.11
Nodes (12): Contract, Operation, Transactions::Operations::Categories::ConvertCategoryHierarchy, Transactions::Operations::Categories::ConvertCategoryHierarchy::Contract, Contract, Operation, Transactions, Transactions::Operations (+4 more)

### Community 199 - "Insights::Queries::MonthlySpending"
Cohesion: 0.16
Nodes (9): Insights, Insights::Queries, Insights::Queries::MonthlySpending, Insights::Queries::MonthlySpending::Contract, Insights::Queries::MonthlySpending::Row, Contract, MonthlyFinancialSummaries, MonthlyFinancialSummaries::Queries (+1 more)

### Community 200 - ".call"
Cohesion: 0.07
Nodes (15): Transactions, Transactions::Queries, Transactions::Queries::BaseQuery, Contract, Transactions, Transactions::Queries, Transactions::Queries::FilteredTransactions, Transactions::Queries::FilteredTransactions::Contract (+7 more)

### Community 201 - "Core capabilities"
Cohesion: 0.08
...
### Community 203 - "build-production.sh"
Cohesion: 0.14
...
### Community 205 - "mobile-sticky-header.tsx"
Cohesion: 0.12
Nodes (23): DashboardPushChildren(), DETAIL_PUSH_DURATION_SEC, DETAIL_PUSH_EASE, DetailPushExitApi, DetailPushExitContext, DetailPushNavigationProvider(), DetailPushPanel(), DetailPushPhase (+15 more)

### Community 206 - "Ai::Rag::Agent::Tools::QueryFinancialData"
Cohesion: 0.18
Nodes (6): Ai, Ai::Rag, Ai::Rag::Agent, Ai::Rag::Agent::Tools, Ai::Rag::Agent::Tools::QueryFinancialData, Tool

### Community 207 - "Ai::Operations::Embeddings::GenerateEmbedding"
Cohesion: 0.07
...
### Community 210 - "ExpenseCostShareFields.tsx"
Cohesion: 0.15
...
### Community 211 - "Design System: Fintr"
Cohesion: 0.09
Nodes (23): Buttons, Cards / Containers, Chips / Badges, Colors, Components, Design System: Fintr, Do:, Do's and Don'ts (+15 more)

### Community 212 - "Content Strategy"
Cohesion: 0.09
Nodes (23): Building a Terminology Glossary, Confirmation Messages, Content Modeling, Content Reuse, Content Strategy, Empty States, Jargon Management, Localization-Ready Content (+15 more)

### Community 213 - "Finance::Operations::Subscriptions::FindOrCreatePayment"
Cohesion: 0.19
Nodes (7): Finance, Finance::Operations, Finance::Operations::Subscriptions, Finance::Operations::Subscriptions::FindOrCreatePayment, Finance::Operations::Subscriptions::FindOrCreatePayment::Contract, Contract, Operation

### Community 214 - "Finance::Operations::Subscriptions::Webhooks::HandlePlanActivated"
Cohesion: 0.18
...
### Community 215 - "Imports::Operations::ProcessImport"
Cohesion: 0.20
...
### Community 216 - "Imports::Operations::RevertImport"
Cohesion: 0.20
...
### Community 217 - "Insights::Operations::CreateSummaryStructure"
Cohesion: 0.17
...
### Community 218 - "Transactions::Account"
Cohesion: 0.06
Nodes (22): Transactions, Transactions::Account, Onboardings, Onboardings::Operations, Onboardings::Operations::SkipOnboarding, Onboardings::Operations::SkipOnboarding::Contract, Contract, Operation (+14 more)

### Community 219 - "Themed.tsx"
Cohesion: 0.16
Nodes (13): styles, styles, styles, EditScreenInfo(), styles, ExternalLink(), MonoText(), Text() (+5 more)

### Community 220 - "Insights::Operations::BuildCustomerProfiles"
Cohesion: 0.19
...
### Community 221 - "Transactions::Operations::Transfers::UpdateAllInSeriesTransfers"
Cohesion: 0.09
...
### Community 222 - "MonthlyFinancialSummaries::Queries::DateRangeSummary"
Cohesion: 0.18
...
### Community 223 - "Integrations::Revenuecat::Client"
Cohesion: 0.12
Nodes (11): Integrations, Integrations::Revenuecat, Integrations::Revenuecat::Client, Integrations, Integrations::Revenuecat, Integrations::Revenuecat::Error, Integrations::Revenuecat::NotConfigured, Integrations::Revenuecat::NotFound (+3 more)

### Community 224 - "Capacitor"
Cohesion: 0.22
Nodes (7): FintrLaunchColors, Capacitor, FBSDKCoreKit, Foundation, Sentry, UIKit, WebKit

### Community 225 - "Information Architecture"
Cohesion: 0.09
Nodes (21): Applied Mental Model Theory, Card Sort and Tree Test Methodology, Dashboard, Don't-Know-What-I-Don't-Know, Exploratory Search, Faceted, Flat, Hierarchical (Tree) (+13 more)

### Community 226 - "Strategize — Frame the Problem"
Cohesion: 0.09
...
### Community 228 - "sveltekit-adapter.mjs"
Cohesion: 0.18
...
### Community 229 - "tanstack-adapter.mjs"
Cohesion: 0.16
...
### Community 230 - "transaction-space-totals.ts"
Cohesion: 0.23
Nodes (15): ExchangeRateLookup, normalizeCurrency(), preloadExchangeRatesForTransactions(), roundMoney(), toSpaceDecimal(), aggregateTotalsInSpaceForRange(), amountNumericForSpaceTotal(), CurrencyConversionLike (+7 more)
...
### Community 232 - "Budgets::Operations::UpdateBudget"
Cohesion: 0.21
...
### Community 233 - "The Philosopher — Sit With the Problem"
Cohesion: 0.10
Nodes (21): Adaptation & Measurement, Check-in at intensity levels, Check-in rhythm, Check-ins and Exiting the Mode, Exiting cleanly, Experience Design, Handoff, How this skill fits the design practice (+13 more)

### Community 234 - "Finance::Operations::Subscriptions::Webhooks::HandlePlanInactivated"
Cohesion: 0.19
...
### Community 235 - "Finance::SubscriptionPlan"
Cohesion: 0.12
Nodes (7): Finance, Finance::ProFeatures, Finance, Finance::SubscriptionPlan, ApplicationRecord, SetProMonthlyAndYearlyPrices, UseRevenuecatSlugsOnProPlans

### Community 236 - "achievements/local-cache.ts"
Cohesion: 0.16
Nodes (21): AppSettingsPage(), getProfile, useGamificationProfile(), achievementsApi, asRecord(), cacheGamificationProfile(), GAMIFICATION_PROFILE_LOCAL_QUERY_KEY, GAMIFICATION_PROFILE_QUERY_KEY (+13 more)

### Community 237 - "Ai::Operations::Receipts::CalculateConfidenceAi"
Cohesion: 0.12
...
### Community 238 - "Transactions::Queries::AccountBalanceTimeline"
Cohesion: 0.13
...
### Community 239 - "Spaces::Operations::UpdateSpace"
Cohesion: 0.10
...
### Community 240 - "Spaces::SpaceUser"
Cohesion: 0.11
...
### Community 243 - "Transactions::Operations::Transfers::CreateTransferFeeTransaction"
Cohesion: 0.05
...
### Community 244 - "Regulatory Landscape"
Cohesion: 0.10
Nodes (20): Addictive Design → Respectful Engagement, Anti-Pattern Remediation Guide, California CPRA (2023) and Automated Decision-Making, Common consent failures, Consent Design Patterns, Consent interface patterns, Consequence Scanning, COPPA (United States, 1998 / Updated 2013) (+12 more)

### Community 245 - "Service Design"
Cohesion: 0.10
Nodes (19): Channel Orchestration, Cross-Channel Consistency, Designing for Moments of Truth, Fail Point Categories, Fail Point Identification and Recovery Design, Identifying Moments of Truth, Modern Blueprint Layers, Moment-of-Truth Analysis (+11 more)

### Community 246 - "useConversations.ts"
Cohesion: 0.15
Nodes (22): ConversationListProps, ConversationRenameDialogProps, useConversations(), useInfiniteMessages(), createConversation(), deleteConversation(), fetchMessagesPage(), getConversation() (+14 more)

### Community 247 - "usePaymentMethods.ts"
Cohesion: 0.30
...
### Community 248 - "collectBrowserFindings"
Cohesion: 0.13
...
### Community 249 - "install-profiles.cjs"
Cohesion: 0.26
Nodes (12): CLEANUP_SIGNALS, cleanupStagedSkills(), ensureExitCleanup(), fs, isMinimalMode(), MINIMAL_ALLOWLIST_SET, MINIMAL_SKILL_ALLOWLIST, os (+4 more)

### Community 250 - "aggregate_benchmark.py"
Cohesion: 0.23
...
### Community 251 - "Budget"
Cohesion: 0.17
Nodes (3): Budget, CategoryAssignable, DefaultToPhp

### Community 252 - "Ai::Operations::Conversations::DeleteConversation"
Cohesion: 0.19
...
### Community 253 - "Budgets::Operations::CreateBudget"
Cohesion: 0.21
...
### Community 254 - "Budgets::Operations::PrepareMonthlyReport"
Cohesion: 0.22
...
### Community 255 - "Finance::Operations::Revenuecat::PresentSubscription"
Cohesion: 0.10
...
### Community 259 - "TutorialContext.tsx"
Cohesion: 0.10
...
### Community 260 - "Imports::Operations::UpdateImportRecord"
Cohesion: 0.22
...
### Community 261 - "planning-workspace.cjs"
Cohesion: 0.11
...
### Community 262 - "Onboardings::Operations::IncomeStep"
Cohesion: 0.11
...
### Community 263 - "ProductPulse::Operations::CreateFeedback"
Cohesion: 0.10
...
### Community 264 - "Spaces::Operations::DeleteSpace"
Cohesion: 0.22
Nodes (6): Contract, Operation, Spaces, Spaces::Operations, Spaces::Operations::DeleteSpace, Spaces::Operations::DeleteSpace::Contract

### Community 265 - "Auth::User"
Cohesion: 0.07
Nodes (11): Secured, UserActivityTrackingJob, Auth, Auth::User, ApplicationRecord, Contract, Operation, Spaces (+3 more)

### Community 266 - "Transactions::Operations::Accounts::VerifyBalanceIntegrity"
Cohesion: 0.21
...
### Community 267 - "Research Methods"
Cohesion: 0.11
Nodes (17): Affinity Mapping, Bias Avoidance in Research, Common Communication Failures, Communicating Findings, Evaluative Methods (Is this working?), Evidence Strength Indicators, Findings Format, Generative Methods (What should we build?) (+9 more)

### Community 268 - "Investigate"
Cohesion: 0.11
Nodes (18): 1. Research planning & method selection, 2. Interview guide construction, 3. Usability test planning, 4. Survey design, 5. Synthesis frameworks, 6. Communicating findings, Core capabilities, Findings report (+10 more)

### Community 269 - "Specify — Bridge Design to Engineering"
Cohesion: 0.11
Nodes (18): 1. Detailed design specifications, 2. Organized engineering handoff packages, 3. Copy and variant matrices, 4. Interactive HTML specification documentation, 5. Use case and edge case documentation, 6. Stakeholder presentations, 7. Test plans with success criteria, Core capabilities (+10 more)

### Community 270 - "Transpose — Adapt Across Contexts"
Cohesion: 0.11
...
### Community 271 - "Transactions::Operations::Categories::ShowAllCategories"
Cohesion: 0.06
...
### Community 272 - "Transactions::Operations::Transfers::DeleteAllInSeriesTransfers"
Cohesion: 0.07
...
### Community 273 - "TransactionEditingChannel"
Cohesion: 0.19
...
### Community 274 - "Budgets::Queries::MonthlyBudgets"
Cohesion: 0.26
...
### Community 276 - "capacitor-loader.tsx"
Cohesion: 0.15
...
### Community 277 - "starter_motion/package.json"
Cohesion: 0.08
Nodes (24): dependencies, framer-motion, react, react-dom, devDependencies, @types/react, @types/react-dom, vite (+16 more)

### Community 278 - "Ai::Rag::InteractionMetadataBuilder"
Cohesion: 0.17
Nodes (7): Ai, Ai::Rag, Ai::Rag::Agent, Ai::Rag::Agent::AuditFormatter, Ai, Ai::Rag, Ai::Rag::InteractionMetadataBuilder

### Community 279 - "Ai::Rag::Agent::Tools::SearchTransactions"
Cohesion: 0.12
Nodes (13): Ai, Ai::Rag, Ai::Rag::Agent, Ai::Rag::Agent::Tools, Ai::Rag::Agent::Tools::SearchTransactions, Tool, Ai, Ai::Rag (+5 more)

### Community 280 - "Ai::Rag::VectorSearcher"
Cohesion: 0.24
Nodes (5): Ai, Ai::Rag, Ai::Rag::EmbeddingError, Ai::Rag::VectorSearcher, StandardError

### Community 281 - "Ai::Operations::Embeddings::GenerateQueryEmbedding"
Cohesion: 0.20
...
### Community 282 - "Admin::Operations::BuildUserActivityDrilldown"
Cohesion: 0.23
...
### Community 283 - "fintr-domain/package.json"
Cohesion: 0.12
Nodes (16): dependencies, zod, devDependencies, typescript, vitest, exports, typescript, vitest (+8 more)

### Community 284 - "Budgets::Operations::CreateMonthlyBudget"
Cohesion: 0.23
...
### Community 285 - "agent/skills/wireframe/references/viewer.js"
Cohesion: 0.20
Nodes (15): fit(), frames, go(), histBack(), indexLinks, linked, nextBtn, prevBtn (+7 more)

### Community 286 - ".agents/skills/wireframe/references/viewer.js"
Cohesion: 0.20
Nodes (15): fit(), frames, go(), histBack(), indexLinks, linked, nextBtn, prevBtn (+7 more)

### Community 287 - "ExchangeRates::Operations::SpaceAmountToAccountCurrency"
Cohesion: 0.24
...
### Community 288 - "Finance::Operations::Subscriptions::GetCurrentSubscriptions"
Cohesion: 0.21
...
### Community 289 - "Imports::Operations::PrepareCategories"
Cohesion: 0.26
Nodes (4): Imports, Imports::Operations, Imports::Operations::PrepareCategories, Operation

### Community 290 - "Integrations::Payments::Xendit::Client"
Cohesion: 0.16
Nodes (4): Integrations, Integrations::Payments, Integrations::Payments::Xendit, Integrations::Payments::Xendit::Client

### Community 291 - "Spaces::Operations::ResetData"
Cohesion: 0.21
Nodes (6): Contract, Operation, Spaces, Spaces::Operations, Spaces::Operations::ResetData, Spaces::Operations::ResetData::Contract

### Community 292 - "Transactions::Operations::Transfers::UpdateThisAndFutureTransfers"
Cohesion: 0.06
...
### Community 293 - "Fintr AI - Backend"
Cohesion: 0.14
Nodes (14): By yourself (You still need to ask how to get the data in staging), Download dump - EC2 # Deprecated, Fintr AI - Backend, Handling .env files, How to get included in the seed, Infrastructure, Installation, Manual Setup (+6 more)

### Community 294 - "expo"
Cohesion: 0.12
Nodes (16): typedRoutes, expo, experiments, icon, ios, name, orientation, scheme (+8 more)

### Community 295 - "Transactions::Operations::Categories::UpdateCategory"
Cohesion: 0.21
...
### Community 296 - "Entities::Operations::GenerateEntityPhoto"
Cohesion: 0.21
...
### Community 297 - "Transactions::Operations::Schedules::FetchDates"
Cohesion: 0.20
...
### Community 298 - "Transactions::Operations::UpdateAllInSeriesTransactions"
Cohesion: 0.10
...
### Community 299 - "Transactions::Operations::Accounts::ResolveAccountActivitySignedBalanceEffect"
Cohesion: 0.22
...
### Community 301 - "CapacitorViewController"
Cohesion: 0.23
Nodes (5): CapacitorViewController, Bool, CAPBridgeViewController, CGFloat, NSObjectProtocol

### Community 302 - "Transactions::Operations::Categories::CreateCategory"
Cohesion: 0.13
...
### Community 304 - "Insights Customer Profiles Design"
Cohesion: 0.12
Nodes (16): API / type shape, Architecture, Assets, Copy tone, Deduping, Goals, Insights Customer Profiles Design, Non-goals (+8 more)

### Community 305 - "Loan payment schedule (standard installment loan)"
Cohesion: 0.12
...
### Community 306 - "Spaces::Operations::CreateOrganizationSpace"
Cohesion: 0.14
...
### Community 307 - ".build"
Cohesion: 0.18
Nodes (7): Ai, Ai::Rag, Ai::Rag::Agent, Ai::Rag::Agent::AnalysisBuilder, Ai, Ai::Rag, Ai::Rag::AnalysisResult

### Community 308 - "Measurement Frameworks"
Cohesion: 0.08
Nodes (23): A/B Test Design, Applying HEART by Feature Type, Common GSM Mistakes, Confidence Intervals, Effect Size, Engagement vs. Wellbeing, Ethical Measurement, Ethical Measurement Principles (+15 more)

### Community 309 - "serve-question.mjs"
Cohesion: 0.13
Nodes (8): esc(), localImages, page(), payloadPath, portArg, QUESTION_DIR, server, timeoutSec

### Community 310 - "ExchangeRates::Operations::PersistApiRates"
Cohesion: 0.24
...
### Community 311 - "Finance::Operations::Subscriptions::FindSpaceSubscriptionByXenditId"
Cohesion: 0.22
...
### Community 314 - "Insights::Operations::CreateExpenseBreakdown"
Cohesion: 0.13
...
### Community 315 - "fintr-logo.tsx"
Cohesion: 0.14
Nodes (15): FINTR_LOGO_DARK_SRC, FINTR_LOGO_LIGHT_SRC, FINTR_LOGO_NAVY_SRC, FINTR_LOGO_SPLASH_SRC, FintrLogoProps, LoadingFintrLogo(), LoadingFintrLogoProps, OfflineSyncScreen() (+7 more)

### Community 316 - "Transactions::Operations::Accounts::DeleteAccount"
Cohesion: 0.22
...
### Community 317 - "Transactions::Operations::PersistCurrencyConversion"
Cohesion: 0.24
Nodes (6): Contract, Operation, Transactions, Transactions::Operations, Transactions::Operations::PersistCurrencyConversion, Transactions::Operations::PersistCurrencyConversion::Contract

### Community 318 - "Bulk Receipt Upload — Feature Specification"
Cohesion: 0.08
Nodes (23): 1. Executive Summary, 2. Background & Motivation, 3. Scope, 4. Current System Overview, 5.1 Access Control, 5.2 User Interface Flow, 5.3 Error Handling, 5. Proposed Feature Design (+15 more)

### Community 319 - "Transactions::Operations::Tags::DeleteTag"
Cohesion: 0.21
...
### Community 321 - "Admin::Queries::DailyActiveUsersQuery"
Cohesion: 0.24
Nodes (5): Admin, Admin::Queries, Admin::Queries::DailyActiveUsersQuery, Admin::Queries::DailyActiveUsersQuery::Contract, Contract

### Community 322 - "vision_client.rb"
Cohesion: 0.21
Nodes (10): Ai, Ai::Llm, Ai::Llm::VisionClient, ask(), attachment_for(), data_url?(), extension_for(), message_text() (+2 more)

### Community 323 - "collectVisualContrastCandidates"
Cohesion: 0.13
...
### Community 324 - "edit-transaction-exchange-rate.spec.ts"
Cohesion: 0.22
Nodes (6): buildIndexRow(), buildTransactionDetail(), MOCK_USER, mockExchangeRateEditFlow(), setupAuth(), StoredTransaction

### Community 326 - "verify-reapply-patches.cjs"
Cohesion: 0.31
Nodes (9): computeUserAddedLines(), fs, isSignificantLine(), main(), parseArgs(), path, REASON, verifyFile() (+1 more)

### Community 327 - "Migration Roadmap (tab-by-tab + offline parity)"
Cohesion: 0.12
Nodes (15): Concrete next actions, Migration Roadmap (tab-by-tab + offline parity), Offline parity checklist (must not regress), Phase 0 — RN infrastructure that must exist before porting screens, Phase 1 — Port Transactions first (offline-first loop), Phase 2 — Home, Phase 3 — Dashboard (Insights), Phase 4 — Menu (App settings + space management) (+7 more)

### Community 328 - "Ai::InteractionTracker::TrackedInteraction"
Cohesion: 0.24
Nodes (3): Ai, Ai::InteractionTracker, Ai::InteractionTracker::TrackedInteraction

### Community 329 - "ExchangeRates::Operations::ConvertSignedAmount"
Cohesion: 0.24
...
### Community 330 - "ExchangeRates::Operations::FetchRatesFromApi"
Cohesion: 0.24
...
### Community 331 - "Bootstrap sync: today vs v2"
Cohesion: 0.12
...
### Community 332 - "ExchangeRates::Operations::UpsertCurrencyConversion"
Cohesion: 0.24
...
### Community 333 - "scroll-to-top-on-navigate.ts"
Cohesion: 0.23
...
### Community 335 - "Articulate"
Cohesion: 0.13
Nodes (15): 1. Voice and tone framework creation, 2. Error message design, 3. Empty state design, 4. CTA and action language, 5. Microcopy patterns, 6. Content modeling, 7. Inclusive language, Articulate (+7 more)

### Community 336 - "MonthlyFinancialSummaries::Queries::CurrentMonthSummary"
Cohesion: 0.24
...
### Community 337 - "generate-image.mjs"
Cohesion: 0.20
Nodes (12): crc32(), hash32(), hslToRgb(), out, palette(), pngChunk(), pngFake(), promptFile (+4 more)

### Community 338 - "account-balance-timeline-local.ts"
Cohesion: 0.25
...
### Community 342 - "Integrations::ExchangeRates::Client"
Cohesion: 0.31
Nodes (3): Integrations, Integrations::ExchangeRates, Integrations::ExchangeRates::Client

### Community 343 - "manual-edit-routes.mjs"
Cohesion: 0.19
...
### Community 344 - "toast-behavior.spec.ts"
Cohesion: 0.24
Nodes (4): triggerE2eToast(), NativeClassOptions, openDashboardForToast(), primeNativePlatformClasses()

### Community 345 - "OfflineAppearanceBridge"
Cohesion: 0.24
...
### Community 346 - "ai-interactions.ts"
Cohesion: 0.27
...
### Community 350 - "category_filter.rb"
Cohesion: 0.33
...
### Community 354 - "categoryAppearance.ts"
Cohesion: 0.08
Nodes (34): CategoryAppearancePicker(), CategoryAppearancePickerProps, TagMultiPickerProps, TagFormDialogProps, DefaultTagPill(), TagsTravelHintPill(), TagsTravelHintPillProps, TravelHintPill() (+26 more)

### Community 355 - "Core capabilities"
Cohesion: 0.14
...
### Community 356 - "Storytelling"
Cohesion: 0.13
Nodes (14): Discipline = what protects the goal from becoming the pathology, Multi-pattern situations, Notes on the set, Output shape, Overview, Skill family, Standalone workflow, Storytelling (+6 more)

### Community 357 - "sampleCssBackground"
Cohesion: 0.22
...
### Community 359 - "Api::V1::InsightsController"
Cohesion: 0.11
Nodes (10): Api, Api::V1, Api::V1::InsightsController, ApiController, Insights, Insights::Operations, Insights::Operations::CreateAccountBreakdown, Insights::Operations::CreateAccountBreakdown::Contract (+2 more)

### Community 360 - "buildDashboardApiJson"
Cohesion: 0.10
...
### Community 361 - "supabase.ts"
Cohesion: 0.22
Nodes (8): CompositeTypes, Database, Enums, Json, PublicSchema, Tables, TablesInsert, TablesUpdate

### Community 362 - "pre-push-frontend.sh"
Cohesion: 0.36
Nodes (6): main(), run_playwright_full(), run_playwright_specs(), run_vitest_for_changes(), run_vitest_full(), pre-push-frontend.sh script

### Community 363 - "runtime-homes.cjs"
Cohesion: 0.39
Nodes (7): expandTilde(), getGlobalConfigDir(), getGlobalSkillDir(), getGlobalSkillDisplayPath(), getGlobalSkillsBase(), os, path

### Community 364 - "FintrConnectionGate"
Cohesion: 0.26
Nodes (8): FintrConnectionGate, Bool, CAPBridgeProtocol, String, URL, WKWebView, NSKeyValueObservation, Timer

### Community 365 - "Api::V1::Auth::SignupController"
Cohesion: 0.29
Nodes (5): Api, Api::V1, Api::V1::Auth, Api::V1::Auth::SignupController, ApiController

### Community 366 - "Auth::Operations::UpdateTutorialCompletion"
Cohesion: 0.24
...
### Community 367 - "Api::V1::Goals::DescriptionsController"
Cohesion: 0.29
Nodes (5): Api, Api::V1, Api::V1::Goals, Api::V1::Goals::DescriptionsController, ApiController

### Community 368 - "model_registry.rb"
Cohesion: 0.29
Nodes (4): Ai, Ai::ModelRegistry, get(), recommend()

### Community 369 - "MonthlyFinancialSummaries::Operations::ListForSpace"
Cohesion: 0.21
...
### Community 370 - "transactions.tsx"
Cohesion: 0.29
Nodes (9): formatMoney(), styles, TransactionsScreen(), createLocalDbAdapter(), LocalDbAdapterKind, LocalDbAdapter, MonthlySnapshotRow, OutboxRow (+1 more)

### Community 374 - "Transactions::Operations::Tags::GenerateTagStyleImage"
Cohesion: 0.20
...
### Community 375 - "initCapacitorBridgeIfNeeded"
Cohesion: 0.12
Nodes (23): APPEARANCE_PLUGIN_HEADER, CACHE_CONTROL_PLUGIN_HEADER, CapacitorBridgeCap, ensureFintrNativePluginImplementations(), FILESHARE_PLUGIN_HEADER, FILESYSTEM_PLUGIN_HEADER, FINTR_NATIVE_PLUGIN_HEADERS, initCapacitorBridgeIfNeeded() (+15 more)

### Community 376 - "Offline mode data manifest"
Cohesion: 0.11
Nodes (19): Account drill-down — required offline, Adding a new offline domain (checklist), AI, CRM, admin — online-only (explicit exceptions), Architecture (three layers), Bootstrap v2 tiers, Core money data — required offline, Import pipeline — online-only (explicit exception), IndexedDB stores (today) (+11 more)

### Community 377 - "generate-service-worker.mjs"
Cohesion: 0.16
Nodes (12): collectPrecacheUrls(), __dirname, feRoot, orderPrecacheUrls(), outDir, precachePriorityTier(), precacheUrls, serveConfig (+4 more)

### Community 378 - "Imports::Queries::ShowImportReport"
Cohesion: 0.29
Nodes (3): Imports, Imports::Queries, Imports::Queries::ShowImportReport

### Community 379 - "Integrations::Payments::Xendit::Error"
Cohesion: 0.25
Nodes (5): Integrations, Integrations::Payments, Integrations::Payments::Xendit, Integrations::Payments::Xendit::Error, StandardError

### Community 380 - "Offline-mode PR stack"
Cohesion: 0.11
Nodes (15): Transactions Realtime (ActionCable), Current status (local), First-time remote setup, Offline-mode PR stack, Open a PR (template), Out of scope for this stack, PR 1 — `@fintr/domain` shared validation (FIN-197), PR 2 — Backend sync foundation (FIN-195 / FIN-196) (+7 more)

### Community 381 - "Evaluate — Assess UX Quality"
Cohesion: 0.15
Nodes (13): 1. Heuristic evaluation, 2. Cognitive walkthrough, 3. Anti-pattern detection, 4. Task success analysis, 5. Assessment-to-action routing, Core capabilities, Evaluate — Assess UX Quality, Evaluation output format (+5 more)

### Community 382 - "Core capabilities"
Cohesion: 0.15
Nodes (13): 1. State inventory, 2. Error recovery design, 3. First-run experience design, 4. Stress testing prompts, 5. Internationalization readiness, 6. Timeout and latency handling, Core capabilities, Fortify — Harden for Real-World Use (+5 more)

### Community 383 - "Finance::Queries::ListSubscriptionPlans"
Cohesion: 0.33
Nodes (3): Finance, Finance::Queries, Finance::Queries::ListSubscriptionPlans

### Community 384 - "ApplicationController"
Cohesion: 0.04
Nodes (27): API, Api, Api::V1, Api::V1::ApiController, ApplicationController, Api, Api::V1, Api::V1::CacheVersionController (+19 more)

### Community 386 - "pin.mjs"
Cohesion: 0.23
...
### Community 387 - "Sentry"
Cohesion: 0.29
Nodes (6): mcp, Sentry, $schema, oauth, type, url

### Community 388 - "product-pulse-feedbacks.ts"
Cohesion: 0.43
...
### Community 390 - "Api::V1::Transactions::TransfersController"
Cohesion: 0.13
Nodes (9): Api, Api::V1, Api::V1::Transactions, Api::V1::Transactions::TransfersController, ApiController, Base, Transactions, Transactions::Serializers (+1 more)
...
### Community 392 - "Crm"
Cohesion: 0.33
Nodes (5): Crm, Crm::Serializers, Crm::Serializers::Admin, Crm::Serializers::Admin::AdminTicketListSerializer, Base

### Community 393 - "Dashboards::Operations::ShowDashboardData"
Cohesion: 0.23
...
### Community 398 - "plugins/navigation-info.ts"
Cohesion: 0.33
Nodes (3): NavigationInfo, NavigationInfoPlugin, webFallback

### Community 399 - "check-latest-version.cjs"
Cohesion: 0.50
...
### Community 403 - "badge-image.tsx"
Cohesion: 0.26
Nodes (11): BadgeImage(), BadgeImageProps, useShellCachedImageSrc(), BADGE_IMAGE_PATHS, badgeImageForKey(), warmBadgeImages(), findShellCacheNameForAsset(), listShellCacheNames() (+3 more)

### Community 404 - "Ai::Rag::Agent::Tools::Auditable"
Cohesion: 0.06
Nodes (23): Ai, Ai::Rag, Ai::Rag::Agent, Ai::Rag::Agent::Tools, Ai::Rag::Agent::Tools::Auditable, Ai, Ai::Rag, Ai::Rag::Agent (+15 more)

### Community 405 - "ApplicationRecord"
Cohesion: 0.04
Nodes (21): ApplicationRecord, Base, Auth, Auth::Role, Crm, Crm::TicketResponse, Transactions, Transactions::AccountActivity (+13 more)

### Community 406 - "calculate-loan-payment-split.ts"
Cohesion: 0.29
...
### Community 414 - "Budgets"
Cohesion: 0.40
Nodes (4): Budgets, Budgets::Serializers, Budgets::Serializers::MonthlyBudgetsSerializer, Base

### Community 415 - "Crm"
Cohesion: 0.40
Nodes (4): Crm, Crm::Serializers, Crm::Serializers::TicketListSerializer, Base

### Community 416 - "Crm"
Cohesion: 0.40
Nodes (4): Crm, Crm::Serializers, Crm::Serializers::TicketResponseSerializer, Base

### Community 417 - "Transactions"
Cohesion: 0.40
Nodes (4): Base, Transactions, Transactions::Serializers, Transactions::Serializers::FilteredAccountActivitySerializer

### Community 418 - "Transactions::Serializers::FilteredCombinedSerializer"
Cohesion: 0.40
Nodes (4): Base, Transactions, Transactions::Serializers, Transactions::Serializers::FilteredCombinedSerializer

### Community 419 - "Transactions"
Cohesion: 0.40
Nodes (4): Base, Transactions, Transactions::Serializers, Transactions::Serializers::FilteredTransactionsSerializer

### Community 421 - "sampleCssBackground"
Cohesion: 0.22
Nodes (14): firstCssUrl(), getLayerValue(), loadVisualContrastImage(), parseObjectPosition(), parsePositionPair(), parsePositionToken(), pickWorstContrastColor(), pointToImageSource() (+6 more)

### Community 422 - "download-dump.sh"
Cohesion: 0.60
Nodes (3): load_env_file(), resolve_ssh_connection(), download-dump.sh script

### Community 423 - "Entities::Queries::AllEntities"
Cohesion: 0.11
Nodes (12): Entities, Entities::Operations, Entities::Operations::ShowEntities, Entities::Operations::ShowEntities::Contract, Contract, Operation, Entities, Entities::Queries (+4 more)

### Community 424 - "profile-pipeline.cjs"
Cohesion: 0.21
...
### Community 425 - "org.junit.Test"
Cohesion: 0.36
Nodes (4): ExampleInstrumentedTest, ExampleUnitTest, org.junit.runner.RunWith, org.junit.Test

### Community 427 - "playwright"
Cohesion: 0.40
Nodes (4): playwright, Sentry, npx, @playwright/mcp

### Community 428 - "eslint.config.mjs"
Cohesion: 0.40
Nodes (4): compat, __dirname, eslintConfig, __filename

### Community 429 - "Transactions::Operations::PrepareCurrencyConversion"
Cohesion: 0.23
Nodes (6): Contract, Operation, Transactions, Transactions::Operations, Transactions::Operations::PrepareCurrencyConversion, Transactions::Operations::PrepareCurrencyConversion::Contract

### Community 430 - "regenerate_android_icons_centered.sh"
Cohesion: 0.70
Nodes (4): gen_foreground(), gen_icon(), gen_round_icon(), regenerate_android_icons_centered.sh script

### Community 432 - "Transactions::Tag"
Cohesion: 0.05
Nodes (30): ApplicationRecord, Transactions, Transactions::Tag, Contract, Operation, Transactions, Transactions::Operations, Transactions::Operations::ResolveTagAssignment (+22 more)

### Community 433 - "Imports::Operations::CreateImport"
Cohesion: 0.15
...
### Community 434 - "pre-commit-backend-rspec.sh"
Cohesion: 0.60
Nodes (3): be_changes_present(), main(), pre-commit-backend-rspec.sh script

### Community 435 - "(tabs)/_layout.tsx"
Cohesion: 0.27
Nodes (7): plugins, RootLayoutNav(), unstable_settings, TabLayout(), useClientOnlyValue(), useColorScheme(), expo-router

### Community 436 - "detect-csp.mjs"
Cohesion: 0.35
Nodes (10): detectCsp(), INLINE_HEADER_SIGNALS, LAYOUT_EXTS, MONOREPO_HELPER_SIGNALS, NUXT_ROUTE_RULES_SIGNALS, NUXT_SECURITY_SIGNALS, SCAN_EXTS, SKIP_DIRS (+2 more)

### Community 437 - "css"
Cohesion: 0.10
Nodes (20): buildSelectorSegment(), generateSelector(), isLikelyHashedClass(), aliases, components, hooks, lib, ui (+12 more)

### Community 438 - "embed-prompt.mjs"
Cohesion: 0.20
Nodes (7): args, buf, crc32(), crcTable, file, pngChunk(), readMode

### Community 439 - "palette.mjs"
Cohesion: 0.24
Nodes (7): args, buildWeights(), hashUnit(), pickSeed(), seed, SEEDS, weightedPick()

### Community 440 - "weekly-feedback.ts"
Cohesion: 0.16
...
### Community 441 - "Core capabilities"
Cohesion: 0.10
...
### Community 442 - "BaseQuery"
Cohesion: 0.05
Nodes (22): Ai, Ai::Queries, Ai::Queries::BaseQuery, Ai, Ai::Queries, Ai::Queries::PaginatedMessages, Ai::Queries::PaginatedMessages::Contract, Contract (+14 more)

### Community 444 - "ExchangeRates::Operations::FetchBatchRates"
Cohesion: 0.24
...
### Community 445 - "Admin::Queries::UsersQuery"
Cohesion: 0.12
...
### Community 446 - "Finance::Operations::Subscriptions::ApplySponsorCode"
Cohesion: 0.14
...
### Community 449 - "Api::V1::Finance::ProGrantAcknowledgementsController"
Cohesion: 0.33
Nodes (5): Api, Api::V1, Api::V1::Finance, Api::V1::Finance::ProGrantAcknowledgementsController, ApiController

### Community 450 - "Transactions::Operations::Transfers::PrepareCurrencyConversion"
Cohesion: 0.22
Nodes (7): Contract, Operation, Transactions, Transactions::Operations, Transactions::Operations::Transfers, Transactions::Operations::Transfers::PrepareCurrencyConversion, Transactions::Operations::Transfers::PrepareCurrencyConversion::Contract

### Community 451 - "useTabSwitchTiming"
Cohesion: 0.29
Nodes (7): HomeScreen(), styles, InsightsScreen(), styles, MenuScreen(), styles, useTabSwitchTiming()

### Community 452 - "dependencies"
Cohesion: 0.18
Nodes (11): dependencies, expo, expo-router, expo-sqlite, react-native, react-native-safe-area-context, expo, expo-router (+3 more)

### Community 453 - "Finance"
Cohesion: 0.50
Nodes (3): Finance, Finance::BillingCycleSerializer, Base

### Community 454 - "Finance::Operations::ProGrants::PresentSubscription"
Cohesion: 0.21
...
### Community 457 - "File map"
Cohesion: 0.18
Nodes (10): API Client Versioning Implementation Plan, File map, Out of scope (do not do in this plan), Self-review, Task 1: Parse client identity from headers, Task 2: Version policy (web current, native cutoffs), Task 3: Assign identity on every request + CORS, Task 4: Advertise policy on GET /cache_version (+2 more)

### Community 458 - "useRevealProgress.ts"
Cohesion: 0.33
...
### Community 462 - "compilerOptions"
Cohesion: 0.18
Nodes (10): compilerOptions, isolatedModules, module, moduleResolution, noEmit, skipLibCheck, strict, target (+2 more)

### Community 469 - "migrate-staging-to-timescaledb.sh"
Cohesion: 0.83
Nodes (3): migrate_table(), migrate_with_sql(), migrate-staging-to-timescaledb.sh script

### Community 470 - "fintr-rn/package.json"
Cohesion: 0.20
Nodes (9): devDependencies, @types/react, typescript, @types/react, typescript, main, name, private (+1 more)

### Community 472 - "ExpenseForm.tsx"
Cohesion: 0.03
Nodes (137): accountOptionsAtom, AmountWithRatePicker(), ConversionSnapshot, multiplierFromApi(), DeleteLoanModal(), DeleteLoanPaymentModal(), categorySchema, ExpenseForm() (+129 more)

### Community 474 - "constants.mjs"
Cohesion: 0.13
...
### Community 475 - "Finance::Operations::Customers::FindOrCreateCustomerForSpace"
Cohesion: 0.18
...
### Community 480 - "Finance::Operations::Subscriptions::Webhooks::HandleCycleRetrying"
Cohesion: 0.16
...
### Community 481 - "Backend TDD E2E Tests"
Cohesion: 0.18
Nodes (10): 1. Start the backend, 2. Run the e2e tests, 3. Environment variables, Adding New Tests, Architecture, Backend TDD E2E Tests, How It Works, Personal workspace login (+2 more)

### Community 482 - "ExchangeRates::Operations::GetRecentRates"
Cohesion: 0.23
Nodes (6): ExchangeRates, ExchangeRates::Operations, ExchangeRates::Operations::GetRecentRates, ExchangeRates::Operations::GetRecentRates::Contract, Contract, Operation

### Community 483 - "installment-edit-stored-exchange-rate.spec.ts"
Cohesion: 0.24
...
### Community 485 - "Insights::Operations::CreateInsightsData"
Cohesion: 0.18
...
### Community 489 - "client-layout.tsx"
Cohesion: 0.17
Nodes (10): ClientLayout(), ClientLayoutProps, GlobalErrorBoundaryProps, GlobalErrorBoundaryState, ErudaDevTools(), OFFLINE_STATUS_BANNER_VISIBLE_MS, OfflineStatusBanner(), PerformanceMonitor() (+2 more)

### Community 490 - "Transactions::Operations::Loans::CalculateLoanPaymentInterest"
Cohesion: 0.18
...
### Community 496 - "Appendix C — JSON schemas"
Cohesion: 0.22
...
### Community 497 - "Appendix D — Frontend module breakdown"
Cohesion: 0.22
...
### Community 498 - "primeWeeklyFeedbackDismissed"
Cohesion: 0.14
Nodes (13): emptyListResponse, minimalBootstrapPayload(), MOCK_MERCHANT, mockOfflineNavigationApi(), OFFLINE_NAV_MOCK_MERCHANT_NAME, primeOfflineSyncComplete(), primeOfflineSyncReady(), primeWeeklyFeedbackDismissed() (+5 more)

### Community 499 - "iOS App Icon Setup"
Cohesion: 0.22
Nodes (8): Icon Sizes, iOS App Icon Setup, iPad Icons, iPhone Icons, Marketing, Regenerating Icons, Source Icon, Validation

### Community 500 - "preview-static.mjs"
Cohesion: 0.22
Nodes (6): child, feRoot, outDir, parsedPort, serveConfigPath, swPath

### Community 502 - "Sync::Operations::PullChanges"
Cohesion: 0.19
...
### Community 522 - "build-local-preview.mjs"
Cohesion: 0.25
Nodes (4): envFile, feRoot, hiddenEnvFiles, productionEnvFiles

### Community 524 - "fintr-be/README.md"
Cohesion: 0.10
Nodes (20): AI Chat + RAG System SOLID Architecture README, API Request Parameters Document, Backend Currency System Document, Error Handling Strategy Document, Installment plans doc, Receipt Processing API Document, Subscription Plan Update Implementation Plan, Understanding Vector Search Distances Document (+12 more)

### Community 525 - "Api::V1::Achievements::AchievementsController"
Cohesion: 0.33
Nodes (5): Api, Api::V1, Api::V1::Achievements, Api::V1::Achievements::AchievementsController, ApiController

### Community 528 - "Appendix G — Sync coordinator"
Cohesion: 0.29
...
### Community 539 - "Eventual consistency when cable fails"
Cohesion: 0.33
...
### Community 542 - "Long offline gap (TTL scenario)"
Cohesion: 0.33
...
### Community 545 - "scripts"
Cohesion: 0.40
Nodes (5): scripts, android, ios, start, web

### Community 546 - "MJ Rathbun AI Bot"
Cohesion: 0.47
Nodes (6): Ars Technica Article, Matplotlib, MJ Rathbun AI Bot, OpenClaw Platform, Scott Shambaugh, Wrathbun Cascade Analysis

### Community 550 - "installmentFormAmounts.ts"
Cohesion: 0.32
...
### Community 564 - "topic_breakdown_builder.rb"
Cohesion: 0.24
...
### Community 565 - "Budgets::Operations::BuildMonthlyBudgetRows"
Cohesion: 0.22
Nodes (4): Budgets, Budgets::Operations, Budgets::Operations::BuildMonthlyBudgetRows, Operation

### Community 566 - "Transactions::Queries::Accounts::DashboardAccounts"
Cohesion: 0.13
...
### Community 568 - "iOS Ad Hoc Distribution Guide"
Cohesion: 0.40
Nodes (5): Create Ad Hoc Provisioning Profile, Creating a Certificate Signing Request (CSR) for Apple Developer, Fix: Provisioning Profile Missing Certificate, iOS Ad Hoc Distribution Guide, Troubleshooting: IPA Won't Install on iPhone

### Community 569 - "Appendix F — Phase 1 implementation runbook"
Cohesion: 0.40
...
### Community 570 - "Ai::Providers::OpenaiFallbackProvider"
Cohesion: 0.18
Nodes (4): Ai, Ai::Providers, Ai::Providers::OpenaiFallbackProvider, BaseProvider

### Community 571 - "params.ts"
Cohesion: 0.39
Nodes (7): fetchInsightsHealthScores(), fetchInsightsNarratives(), buildInsightsApiParams(), fetchInsightSection(), formatDateForAPI(), getLastDayOfMonth(), getMonthNumber()

### Community 572 - "Ai::Providers::OpenrouterProvider"
Cohesion: 0.18
Nodes (4): Ai, Ai::Providers, Ai::Providers::OpenrouterProvider, BaseProvider

### Community 573 - "Ai::Rag::Agent::RetrievalCollector"
Cohesion: 0.17
Nodes (4): Ai, Ai::Rag, Ai::Rag::Agent, Ai::Rag::Agent::RetrievalCollector

### Community 574 - "Achievements::Operations::UnlockAchievement"
Cohesion: 0.07
Nodes (22): Achievements, Achievements::Achievement, Achievements, Achievements::UserAchievement, Achievements, Achievements::Operations, Achievements::Operations::BackfillUser, Achievements::Operations::BackfillUser::Contract (+14 more)

### Community 575 - "Achievements::UserGamificationStat"
Cohesion: 0.15
...
### Community 576 - "Finance::Operations::Subscriptions::SimulateCyclePayment"
Cohesion: 0.18
...
### Community 577 - "Finance::Operations::Subscriptions::Webhooks::HandleCycleCreated"
Cohesion: 0.17
Nodes (8): Finance, Finance::Operations, Finance::Operations::Subscriptions, Finance::Operations::Subscriptions::Webhooks, Finance::Operations::Subscriptions::Webhooks::HandleCycleCreated, Finance::Operations::Subscriptions::Webhooks::HandleCycleCreated::Contract, Contract, Operation

### Community 578 - "Finance::Operations::Webhooks::HandleWebhook"
Cohesion: 0.17
Nodes (7): Finance, Finance::Operations, Finance::Operations::Webhooks, Finance::Operations::Webhooks::HandleWebhook, Finance::Operations::Webhooks::HandleWebhook::Contract, Contract, Operation

### Community 579 - "Transactions::Transaction"
Cohesion: 0.06
Nodes (14): Repeatable, Transactions, Transactions::Transaction, Contract, Operation, Transactions, Transactions::Operations, Transactions::Operations::DeleteTransaction (+6 more)

### Community 580 - "detect.mjs"
Cohesion: 0.50
Nodes (3): candidates, detectorPath, __dirname

### Community 581 - "readConfig"
Cohesion: 0.19
...
### Community 582 - "bundle"
Cohesion: 0.17
Nodes (9): activate_bundler(), activation_error_handling(), bundler_requirement(), bundler_requirement_for(), cli_arg_version(), invoked_as_script?(), gradlew script, die() (+1 more)

### Community 583 - "Auth::Client"
Cohesion: 0.14
Nodes (6): Auth, Auth::Client, Auth, Auth::Response, Auth, Auth::Token

### Community 584 - "Entities::Operations::DeleteMerchantAlias"
Cohesion: 0.24
...
### Community 586 - "Entities::Operations::CreateMerchantAlias"
Cohesion: 0.24
...
### Community 588 - "seo-config.ts"
Cohesion: 0.23
Nodes (12): dynamic, robots(), dynamic, sitemap(), BLOG_ARTICLES, BlogArticle, buildBlogArticleUrl(), ROBOTS_DISALLOW_PATHS (+4 more)

### Community 589 - "login.ts"
Cohesion: 0.23
Nodes (15): getUserProfile(), LoginError, LoginResponse, loginWithCredentials(), refreshAccessToken(), SignupResponse, signupWithCredentials(), formatErrorDetails() (+7 more)

### Community 590 - "bootstrap-scripts.tsx"
Cohesion: 0.21
...
### Community 595 - "scanCssTextForPulsingDot"
Cohesion: 0.16
...
### Community 596 - "Entities::MerchantImageFinder"
Cohesion: 0.19
Nodes (4): Entities, Entities::MerchantImageFinder, find(), find_all()

### Community 597 - "ExpenseForm.test.tsx"
Cohesion: 0.13
...
### Community 599 - "preset-style-images.ts"
Cohesion: 0.23
...
### Community 600 - "Crm::Operations::CreateTicketResponse"
Cohesion: 0.20
Nodes (6): Crm, Crm::Operations, Crm::Operations::CreateTicketResponse, Crm::Operations::CreateTicketResponse::Contract, Contract, Operation

### Community 601 - "Finance::Operations::Subscriptions::CancelSubscription"
Cohesion: 0.19
Nodes (7): Finance, Finance::Operations, Finance::Operations::Subscriptions, Finance::Operations::Subscriptions::CancelSubscription, Finance::Operations::Subscriptions::CancelSubscription::Contract, Contract, Operation

### Community 603 - "Spaces::Operations::RemoveUser"
Cohesion: 0.11
Nodes (11): Api, Api::V1, Api::V1::Auth, Api::V1::Auth::PrivateController, ApiController, Contract, Operation, Spaces (+3 more)

### Community 604 - "add-transaction-calendar.spec.ts"
Cohesion: 0.43
...
### Community 607 - "Entities::Operations::ShowEntity"
Cohesion: 0.21
...
### Community 618 - "Apple Sign In Setup Guide"
Cohesion: 0.50
...
### Community 631 - "Finance::Operations::Subscriptions::FindOrCreateBillingCycle"
Cohesion: 0.20
Nodes (7): Finance, Finance::Operations, Finance::Operations::Subscriptions, Finance::Operations::Subscriptions::FindOrCreateBillingCycle, Finance::Operations::Subscriptions::FindOrCreateBillingCycle::Contract, Contract, Operation

### Community 651 - "Onboardings::Operations::AccountsStep"
Cohesion: 0.21
...
### Community 652 - "Api::V1::Transactions::LoansController"
Cohesion: 0.13
Nodes (9): Api, Api::V1, Api::V1::Transactions, Api::V1::Transactions::LoansController, ApiController, Loans, Loans::Serializers, Loans::Serializers::LoanSerializer (+1 more)

### Community 653 - "Entities::Entity"
Cohesion: 0.16
Nodes (8): Entities, Entities::Entity, Entities, Entities::Operations, Entities::Operations::CreateEntity, Entities::Operations::CreateEntity::Contract, Contract, Operation

### Community 654 - "filterFindings"
Cohesion: 0.14
...
### Community 656 - "Crm::Operations::Admin::CreateAdminResponse"
Cohesion: 0.19
...
### Community 657 - "Transactions::Operations::Tags::AssignPresetStyleImage"
Cohesion: 0.09
...
### Community 658 - "Finance::Operations::Subscriptions::CreateBillingCycle"
Cohesion: 0.21
Nodes (7): Finance, Finance::Operations, Finance::Operations::Subscriptions, Finance::Operations::Subscriptions::CreateBillingCycle, Finance::Operations::Subscriptions::CreateBillingCycle::Contract, Contract, Operation

### Community 659 - "Finance::Operations::Subscriptions::RemoveFreeSubscription"
Cohesion: 0.21
...
### Community 660 - "Transactions::Category"
Cohesion: 0.11
Nodes (9): Transactions, Transactions::Category, Imports, Imports::Operations, Imports::Operations::Categories, Imports::Operations::Categories::FindOrCreateCategory, Imports::Operations::Categories::FindOrCreateCategory::Contract, Contract (+1 more)

### Community 661 - "Transactions::Operations::Categories::DeleteCategory"
Cohesion: 0.21
Nodes (7): Contract, Operation, Transactions, Transactions::Operations, Transactions::Operations::Categories, Transactions::Operations::Categories::DeleteCategory, Transactions::Operations::Categories::DeleteCategory::Contract

### Community 662 - "Transactions::Operations::Reports::DownloadCsv"
Cohesion: 0.19
...
### Community 663 - "Api::V1::OnboardingsController"
Cohesion: 0.14
Nodes (4): Api, Api::V1, Api::V1::OnboardingsController, ApiController

### Community 664 - "Admin::Queries::SpacesForFreeSubscriptionQuery"
Cohesion: 0.21
...
### Community 665 - "Goals::Operations::UpdateGoalDescription"
Cohesion: 0.19
...
### Community 666 - "Transactions::Queries::NoteSuggestions"
Cohesion: 0.22
...
### Community 667 - "app_settings/page.tsx"
Cohesion: 0.09
Nodes (25): SettingsCard, settingsMenuCardClassName, SettingsSection, AchievementDetailSheet(), AchievementDetailSheetProps, BadgeShelf(), BadgeShelfProps, CATEGORY_LABELS (+17 more)

### Community 668 - "Spaces::Operations::LeaveSpace"
Cohesion: 0.21
Nodes (6): Contract, Operation, Spaces, Spaces::Operations, Spaces::Operations::LeaveSpace, Spaces::Operations::LeaveSpace::Contract

### Community 669 - "Api::V1::Finance::SubscriptionsController"
Cohesion: 0.15
Nodes (5): Api, Api::V1, Api::V1::Finance, Api::V1::Finance::SubscriptionsController, ApiController

### Community 670 - "Auth::Operations::ResetPassword"
Cohesion: 0.21
Nodes (6): Auth, Auth::Operations, Auth::Operations::ResetPassword, Auth::Operations::ResetPassword::Contract, Contract, Operation

### Community 682 - "ExchangeRates::Operations::AmountInSpaceCurrency"
Cohesion: 0.23
Nodes (6): ExchangeRates, ExchangeRates::Operations, ExchangeRates::Operations::AmountInSpaceCurrency, ExchangeRates::Operations::AmountInSpaceCurrency::Contract, Contract, Operation

### Community 683 - "MonthlyFinancialSummaries::Operations::RecalculateSpaceSummaries"
Cohesion: 0.16
...
### Community 684 - "App.jsx"
Cohesion: 0.25
Nodes (6): App(), DraggableBox(), HoverCard(), container, item, StaggerList()

### Community 685 - "Ai::Conversations::MessageRepository"
Cohesion: 0.24
Nodes (3): Ai, Ai::Conversations, Ai::Conversations::MessageRepository

### Community 700 - "Ai::Providers::BaseProvider"
Cohesion: 0.20
Nodes (6): Ai, Ai::Providers, Ai::Providers::BaseProvider, Ai::Providers::ProviderError, Ai::Providers::UnknownProviderError, StandardError

### Community 701 - "Imports::Operations::BulkImportTransactions"
Cohesion: 0.25
...
### Community 704 - "Budgets::Operations::ValidateCategoryBudgetAllocation"
Cohesion: 0.23
...
### Community 705 - "calculator-keyboard-history.ts"
Cohesion: 0.31
...
### Community 708 - "Ai::Operations::Conversations::CreateConversation"
Cohesion: 0.21
Nodes (7): Ai, Ai::Operations, Ai::Operations::Conversations, Ai::Operations::Conversations::CreateConversation, Ai::Operations::Conversations::CreateConversation::Contract, Contract, Operation

### Community 709 - "ExchangeRates::Operations::GetCachedApiRate"
Cohesion: 0.24
...
### Community 710 - "Sync::Operations::AllocateSpaceSeq"
Cohesion: 0.24
...
### Community 713 - "Entities::Operations::UpdateEntity"
Cohesion: 0.23
...
### Community 714 - "Matplotlib AI Agent Incident by Miko"
Cohesion: 1.00
...
### Community 723 - "Transactions::Operations::Transfers::PersistCurrencyConversion"
Cohesion: 0.36
...
### Community 724 - "Fintr Frontend README"
Cohesion: 0.22
Nodes (8): Fintr Frontend Dark Mode Design Reference, Android Native Bridge & Auth Redirect Troubleshooting, Debug Capacitor App in iOS Simulator, How to Debug iOS App Issues, Offline IndexedDB (FIN-194), Fintr Frontend README, Change workflow (required), Testing Guide for Fintr Frontend

### Community 725 - "Finance::Operations::ProGrants::GrantYear"
Cohesion: 0.21
...
### Community 726 - "useVisualViewportRect.test.ts"
Cohesion: 0.28
Nodes (3): readVisualViewportRect(), useVisualViewportRect(), VisualViewportRect

### Community 727 - "Onboardings::Operations::ShowCurrencyData"
Cohesion: 0.23
...
### Community 728 - "loanAmortization.ts"
Cohesion: 0.30
...
### Community 730 - "next-dev-rewrites.ts"
Cohesion: 0.47
Nodes (3): nextConfig, NextDevRewrite, nextDevRewrites()

### Community 731 - "Auth::Operations::HandleGoogleTokens"
Cohesion: 0.32
Nodes (4): Auth, Auth::Operations, Auth::Operations::HandleGoogleTokens, Operation

### Community 732 - "Api::V1::MonthlyFinancialSummariesController"
Cohesion: 0.33
Nodes (4): Api, Api::V1, Api::V1::MonthlyFinancialSummariesController, ApiController

### Community 733 - "ExchangeRates::SyncDailyRatesJob"
Cohesion: 0.15
...
### Community 734 - "checkTextOcclusionDOM"
Cohesion: 0.22
...
### Community 738 - "schema-detect.cjs"
Cohesion: 0.40
Nodes (4): checkSchemaDrift(), detectSchemaFiles(), ORM_INFO, SCHEMA_PATTERNS

### Community 739 - "Api::V1::EntitiesController"
Cohesion: 0.18
Nodes (4): Api, Api::V1, Api::V1::EntitiesController, ApiController

### Community 742 - "expense-breakdown-center-label.tsx"
Cohesion: 0.47
Nodes (4): CenterLabelViewBox, ExpenseBreakdownCenterLabel(), ExpenseBreakdownCenterLabelProps, resolveCenterCoordinate()

### Community 743 - "parseIgnoreColor"
Cohesion: 0.18
...
### Community 744 - "pre-commit-graphify.sh"
Cohesion: 0.33
Nodes (4): GRAPHIFY_CHANGED, GRAPHIFY_NO_BACKUP, PYTHONHASHSEED, pre-commit-graphify.sh script

### Community 745 - "Finance::Operations::Revenuecat::HandleWebhook"
Cohesion: 0.25
Nodes (5): Finance, Finance::Operations, Finance::Operations::Revenuecat, Finance::Operations::Revenuecat::HandleWebhook, Operation

### Community 746 - "Entities::Operations::SearchEntityPhotos"
Cohesion: 0.24
...
### Community 747 - "Transactions::Operations::Schedules::CreateSchedule"
Cohesion: 0.22
...
### Community 748 - "Admin"
Cohesion: 0.40
Nodes (4): Admin, Admin::Serializers, Admin::Serializers::SpaceForFreeSubscriptionSerializer, Base

### Community 749 - "Admin"
Cohesion: 0.40
Nodes (4): Admin, Admin::Serializers, Admin::Serializers::UserSerializer, Base

### Community 750 - "MonthlyFinancialSummaries::Serializers::MonthlyFinancialSummarySerializer"
Cohesion: 0.40
...
### Community 751 - "build-development.sh"
Cohesion: 0.40
Nodes (4): CAPACITOR_SERVER_URL, NEXT_PUBLIC_APP_BASE_URL, NEXT_PUBLIC_BE_URL, build-development.sh script

### Community 753 - "artifacts.cjs"
Cohesion: 0.67
Nodes (3): CANONICAL_EXACT, CANONICAL_PATTERNS, isCanonicalPlanningFile()

### Community 754 - "image_client.rb"
Cohesion: 0.22
Nodes (8): Ai, Ai::Llm, Ai::Llm::ImageClient, Ai::Llm::ImageClient::Error, build_body(), generate(), parse_response(), StandardError

### Community 756 - "ApplicationCable"
Cohesion: 0.50
Nodes (3): ApplicationCable, ApplicationCable::Channel, Base

### Community 757 - "Api::V1::Admin::UserActivityController"
Cohesion: 0.22
Nodes (5): Api, Api::V1, Api::V1::Admin, Api::V1::Admin::UserActivityController, ApiController

### Community 758 - "Api::V1::Auth::UserController"
Cohesion: 0.22
Nodes (5): Api, Api::V1, Api::V1::Auth, Api::V1::Auth::UserController, ApiController
...
### Community 762 - "rack-mini-profiler-inline-bootstrap.ts"
Cohesion: 0.27
Nodes (7): RootLayout(), RackMiniProfilerPendingFlush(), Window, RackMiniProfilerSpa(), Window, RACK_MINI_PROFILER_ASSET_VERSION, shouldEnableRackMiniProfiler()

### Community 763 - "compress.ts"
Cohesion: 0.31
...
### Community 778 - "loan-entity-profiles.ts"
Cohesion: 0.31
Nodes (9): buildCurrencyBalance(), buildLoanEntityProfiles(), directionFromNet(), LoanEntityBalanceDirection, LoanEntityCurrencyBalance, LoanEntityProfile, normalizeEntityKey(), parseAmount() (+1 more)

### Community 779 - "bottom-navigation.test.tsx"
Cohesion: 0.29
Nodes (6): addReceiptDialog, addTransactionDialog, aiChatModal, mockUsePlatformDetection, proAccess, webPlatform

### Community 786 - "Api::V1::BudgetsController"
Cohesion: 0.22
Nodes (4): Api, Api::V1, Api::V1::BudgetsController, ApiController

### Community 788 - "Imports::Queries::ListImportRecords"
Cohesion: 0.31
Nodes (3): Imports, Imports::Queries, Imports::Queries::ListImportRecords

### Community 822 - "pick-device-image.ts"
Cohesion: 0.33
...
### Community 823 - "checkRadialSpotlight"
Cohesion: 0.32
...
### Community 829 - "Onboardings::Operations::DelegateStep"
Cohesion: 0.32
Nodes (4): Onboardings, Onboardings::Operations, Onboardings::Operations::DelegateStep, Operation

### Community 832 - "AmountWithRatePicker.test.tsx"
Cohesion: 0.29
Nodes (6): defaultProps, mockedGetCurrentRate, mockedGetRecentRates, mockedResolveAutoExchangeRates, rateForPair(), resolved()

### Community 835 - "errors.ts"
Cohesion: 0.29
Nodes (5): assertValid(), DomainValidationError, DomainValidationFailure, FieldErrorMap, zodErrorToFieldMap()

### Community 836 - "template.cjs"
Cohesion: 0.29
Nodes (6): cmdTemplateSelect(), fs, { normalizePhaseName, findPhaseInternal, generateSlugInternal, normalizeMd, toPosixPath, output, error }, path, { planningDir }, { reconstructFrontmatter }

### Community 837 - "Api::V1::Auth::TutorialController"
Cohesion: 0.29
Nodes (5): Api, Api::V1, Api::V1::Auth, Api::V1::Auth::TutorialController, ApiController

### Community 843 - "Api::V1::ProductPulseFeedbacksController"
Cohesion: 0.33
Nodes (4): Api, Api::V1, Api::V1::ProductPulseFeedbacksController, ApiController

### Community 844 - "loan-create-toast.spec.ts"
Cohesion: 0.29
Nodes (3): MOCK_USER, mockLoanCreateFlow(), setupAuth()

### Community 847 - "calculation-breakdown-content.tsx"
Cohesion: 0.38
Nodes (4): CalculationBreakdownContent(), CalculationBreakdownContentProps, HealthScoreFactorRowProps, MetricCalculation

### Community 851 - "react-dom"
Cohesion: 0.67
Nodes (3): react-dom, react-dom, react-dom

### Community 852 - "normalizeGitHubEvent"
Cohesion: 0.47
Nodes (6): applyPatchText(), envProjectDir(), looksLikeApplyPatch(), normalizeGitHubEvent(), normalizeHookEvent(), parseGitHubToolArgs()

### Community 853 - "Api::V1::DashboardsController"
Cohesion: 0.33
Nodes (4): Api, Api::V1, Api::V1::DashboardsController, ApiController

### Community 855 - "Api::V1::Finance::ProAccessController"
Cohesion: 0.33
Nodes (5): Api, Api::V1, Api::V1::Finance, Api::V1::Finance::ProAccessController, ApiController

### Community 856 - "Api::V1::Finance::RevenuecatSyncController"
Cohesion: 0.33
Nodes (5): Api, Api::V1, Api::V1::Finance, Api::V1::Finance::RevenuecatSyncController, ApiController

### Community 858 - "Api::V1::Imports::SampleTemplatesController"
Cohesion: 0.33
Nodes (5): Api, Api::V1, Api::V1::Imports, Api::V1::Imports::SampleTemplatesController, ApiController

### Community 880 - "Api::V1::Transactions::DraftsController"
Cohesion: 0.33
Nodes (5): Api, Api::V1, Api::V1::Transactions, Api::V1::Transactions::DraftsController, ApiController

### Community 886 - "ProductPulse::Serializers::FeedbackSerializer"
Cohesion: 0.33
Nodes (4): ProductPulse, ProductPulse::Serializers, ProductPulse::Serializers::FeedbackSerializer, Base

### Community 889 - "realtime-actor-toast.tsx"
Cohesion: 0.13
Nodes (24): Toaster(), toasterCssVars, CLIENT_TAB_ID_HEADER, getClientTabId(), isRealtimeOriginFromThisTab(), newClientTabId(), OPEN_TRANSACTION_EVENT, requestOpenTransaction() (+16 more)

### Community 895 - "Spaces::Serializers::DashboardSerializer"
Cohesion: 0.33
Nodes (4): Base, Spaces, Spaces::Serializers, Spaces::Serializers::DashboardSerializer

### Community 896 - "insight-narrative-cards.tsx"
Cohesion: 0.20
Nodes (10): InsightIllustrationCard(), InsightNarrativeCard(), InsightNarrativeCardsProps, severityStyles, categorySpikeInsight, proAccess, PROFILE_IMAGE_PATHS, profileImageForKey() (+2 more)

### Community 902 - "autoFxRateSelection.ts"
Cohesion: 0.60
Nodes (4): fxPairChanged(), FxRatePair, selectAutoFxRate(), shouldPreferCurrentRateOverRecent()

### Community 903 - "loanContactOutstanding.ts"
Cohesion: 0.47
Nodes (4): addByCurrency(), CurrencyAmount, LoanContactOutstanding, LoanOutstandingInput

### Community 904 - "Budgets::Queries::BaseQuery"
Cohesion: 0.40
Nodes (3): Budgets, Budgets::Queries, Budgets::Queries::BaseQuery

### Community 905 - "Entities::Serializers::EntityDetailSerializer"
Cohesion: 0.40
Nodes (4): Entities, Entities::Serializers, Entities::Serializers::EntityDetailSerializer, Base

### Community 906 - "Entities::Serializers::MerchantAliasSerializer"
Cohesion: 0.40
Nodes (4): Entities, Entities::Serializers, Entities::Serializers::MerchantAliasSerializer, Base

### Community 907 - "Spaces::Serializers::SpaceUserSerializer"
Cohesion: 0.40
Nodes (4): Base, Spaces, Spaces::Serializers, Spaces::Serializers::SpaceUserSerializer

### Community 908 - "Api::V1::Entities::IdentifiersController"
Cohesion: 0.25
Nodes (5): Api, Api::V1, Api::V1::Entities, Api::V1::Entities::IdentifiersController, ApiController

### Community 910 - "Transactions"
Cohesion: 0.50
Nodes (3): Transactions, Transactions::Operations, Transactions::Operations::Categories

### Community 911 - "Transactions"
Cohesion: 0.50
...
### Community 921 - "typescript"
Cohesion: 0.67
Nodes (3): typescript, typescript, typescript

### Community 922 - "@vitejs/plugin-react"
Cohesion: 0.67
Nodes (3): @vitejs/plugin-react, @vitejs/plugin-react, @vitejs/plugin-react

## Knowledge Gaps
- **2528 isolated node(s):** `nextConfig`, `NEXT_PUBLIC_APP_BASE_URL`, `NEXT_OUTPUT_MODE`, `NODE_ENV`, `NEXT_PUBLIC_APP_BASE_URL` (+2523 more)
...
- **Why does `Space` connect `bootstrap-local-data.ts` to `Spaces::Operations::CreateOrganizationSpace`, `transactions/index.tsx`, `Auth::Operations::CreateUserAndSpace`, `transactions/create-local-first.ts`?**
...
- **Why does `error()` connect `error` to `button.tsx`, `cn`, `transactions/index.tsx`, `loans/local-cache.ts`, `planning-workspace.cjs`, `TutorialContext.tsx`, `planningDir`, `transactionTypes.ts`, `lib/api.ts`, `output`, `pro-plan-card.tsx`, `convert-local-first.ts`, `plugins/navigation-info.ts`, `transactions/local-cache.ts`, `useGetSpaceCode.ts`, `ensure-monthly-budgets-local-first.ts`, `useSubscriptions.ts`, `category-detail-content.tsx`, `GridPicker.tsx`, `account-cache-ops.ts`, `config.cjs`, `useAuthApi`, `exchangeRates/queries.ts`, `bootstrap-local-data.ts`, `transactions/delete-local-first.ts`, `profile-pipeline.cjs`, `purchase-pro.ts`, `entities/local-cache.ts`, `verify.cjs`, `profile-output.cjs`, `gap-checker.cjs`, `runCommand`, `providers.tsx`, `expense-breakdown-card.tsx`, `google-signin.ts`, `offline-calculations.ts`, `useTickets.ts`, `transactions/create-local-first.ts`, `concept-seed.mjs`, `generation-preflight.mjs`, `AuthContext.tsx`, `template.cjs`, `login.ts`, `local-db/index.ts`, `core.cjs`, `useAiChat.ts`, `preset-style-images.ts`, `ExpenseForm.tsx`, `learnings.cjs`, `initCapacitorBridgeIfNeeded`, `achievements/local-cache.ts`, `extractFrontmatter`, `useImport.ts`, `useConversations.ts`, `detail-local.ts`?**
...
- **What connects `nextConfig`, `NEXT_PUBLIC_APP_BASE_URL`, `NEXT_OUTPUT_MODE` to the rest of the system?**
  _2528 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `button.tsx` be split into smaller, more focused modules?**
  _Cohesion score 0.024296929345125708 - nodes in this community are weakly interconnected._
- **Should `transaction-detail-content.tsx` be split into smaller, more focused modules?**
  _Cohesion score 0.03250174569923189 - nodes in this community are weakly interconnected._