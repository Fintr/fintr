...
module Transactions
  module Operations
    class CreateRepeatTransactions < Dry::Operation
      ...
      def validate(transaction_id:, date_end:)
        contract = Contract.new.call(transaction_id:, date_end:)
      ...
      def call(transaction_id:, date_end: Time.zone.today + 1.month)
        _                 = step validate(transaction_id:, date_end:)
        ...
        dates             = step fetch_dates(schedule:, date_end:)
      ...
      def find_transaction(transaction_id:)
        ...
        Failure(transaction_id: "not found")
      end
      ...
      def fetch_dates(schedule:, date_end:)
