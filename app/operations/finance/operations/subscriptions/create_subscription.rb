  ...
  module Operations
    module Subscriptions
      class CreateSubscription < Dry::Operation
        ...
        def create_xendit_subscription(space:, subscription_plan:, customer_data:, params:)
          ...
          xendit_params = {
            ...
            amount: subscription_plan.price_cents / 100.0,
            schedule: schedule,
            notification_config: {
              locale: "en",
        ...
        def create_space_subscription(space:, subscription_plan:, xendit_response:, customer_data:, params:)
