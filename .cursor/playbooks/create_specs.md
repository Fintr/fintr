...
8. Test the spec for rubocop offenses. Run `bundle exec rubocop <location>`. If there are auto-correctable offenses, fix them by running `bundle exec rubocop -A <location>`
