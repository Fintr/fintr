...
<required_reading>
@.ai/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@.ai/get-shit-done/references/debugger-philosophy.md
...
Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = .ai/get-shit-done (repo copy)
                  → writes to .ai/get-shit-done/hooks/
...
@.ai/get-shit-done/references/thinking-models-debug.md
...
- Read @.ai/get-shit-done/references/common-bug-patterns.md
