...
<template>
@.ai/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@.ai/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `.ai/get-shit-done/workflows/transition.md`.
...
- Follow @.ai/get-shit-done/workflows/diagnose-issues.md
