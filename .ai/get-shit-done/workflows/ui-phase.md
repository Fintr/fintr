...
```markdown
Read .ai/get-shit-done/agents/gsd-ui-researcher.md for instructions.
...
Template: .ai/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read .ai/get-shit-done/agents/gsd-ui-checker.md for instructions.
