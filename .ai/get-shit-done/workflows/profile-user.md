...
Key references:
- @.ai/get-shit-done/references/ui-brand.md (display patterns)
- @.ai/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @.ai/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH=".ai/get-shit-done/USER-PROFILE.md"
...
```bash
cp ".ai/get-shit-done/USER-PROFILE.md" "$HOME/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at .ai/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `.ai/get-shit-done/references/user-profiling.md`
...
Reference: @.ai/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to .ai/get-shit-done/USER-PROFILE.md"
...
**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at .ai/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Your profile:    .ai/get-shit-done/USER-PROFILE.md
```
