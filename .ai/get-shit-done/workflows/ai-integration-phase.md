...
<required_reading>
@.ai/get-shit-done/references/ai-frameworks.md
@.ai/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read .ai/get-shit-done/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp ".ai/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read .ai/get-shit-done/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read .ai/get-shit-done/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read .ai/get-shit-done/agents/gsd-eval-planner.md for instructions.
