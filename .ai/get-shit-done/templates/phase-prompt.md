...
<!-- For checkpoint task examples and patterns, see @.ai/get-shit-done/references/checkpoints.md -->
...
See `.ai/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `.ai/get-shit-done/workflows/verify-phase.md` for verification logic.
