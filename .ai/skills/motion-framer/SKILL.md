...
_Vendored from [freshtechbro/claudedesignskills — motion-framer](https://github.com/freshtechbro/claudedesignskills/tree/main/.claude/skills/motion-framer). Refresh by re-copying that directory if upstream updates._
...
**references/**
- `api_reference.md` - Motion / Framer Motion API reference (from upstream)
- `variants_patterns.md` - Variant orchestration patterns (maintained in this repo; not in upstream bundle)
- `gesture_guide.md` - Gestures, drag, and viewport interaction (maintained in this repo; not in upstream bundle)
